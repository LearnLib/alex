...
import {CompleteEqOracle} from '../../../src/js/entities/eq-oracles/complete-eq-oracle';
import {RandomEqOracle} from '../../../src/js/entities/eq-oracles/random-eq-oracle';
import {SampleEqOracle} from '../../../src/js/entities/eq-oracles/sample-eq-oracle';
import {WMethodEqOracle} from '../../../src/js/entities/eq-oracles/w-method-eq-oracle';
