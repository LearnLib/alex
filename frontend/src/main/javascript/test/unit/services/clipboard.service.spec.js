describe('ClipboardService', () => {
    ...
    it('should should copy an item correctly', () => {
        ...
        expect(ClipboardService.entries['test']).toBeTruthy();
        expect(ClipboardService.entries['test'].mode).toEqual('copy');
    });
    ...
    it('should cut an item correctly', () => {
        ...
        expect(ClipboardService.entries['test']).toBeTruthy();
        expect(ClipboardService.entries['test'].mode).toEqual('cut');
    });

    it('should cut and paste an item correctly', () => {
        ClipboardService.cut('test', item);
        const cutItem = ClipboardService.paste('test');
        expect(ClipboardService.entries['test']).toBeFalsy();
