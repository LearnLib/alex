...
import {ActionCreateModalComponent} from '../../../../src/js/components/modals/action-create-modal/action-create-modal.component';
...
describe('ActionCreateModalController', () => {
    ...
    function createController() {
        controller = $controller(ActionCreateModalComponent, {
