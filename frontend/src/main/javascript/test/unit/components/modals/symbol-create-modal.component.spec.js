...
import {SymbolCreateModalComponent} from '../../../../src/js/components/modals/symbol-create-modal/symbol-create-modal.component';
...
describe('symbolCreateModal', () => {
    ...
    function createController() {
        ...
        controller = $controller(SymbolCreateModalComponent, {
