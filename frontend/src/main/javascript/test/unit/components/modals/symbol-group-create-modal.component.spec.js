...
import {SymbolGroupCreateModalComponent} from '../../../../src/js/components/modals/symbol-group-create-modal/symbol-group-create-modal.component';
...
describe('SymbolGroupCreateModalComponent', () => {
    ...
    function createController() {
        controller = $controller(SymbolGroupCreateModalComponent, {
