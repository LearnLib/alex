...
export class LearnerResultApiService extends BaseApiService {
   ...
   */
  remove(result: LearnResult): Observable<any> {
   ...
   */
  removeMany(results: LearnResult[]): Observable<any> {
   ...
   */
  clone(result: LearnResult): Observable<LearnResult> {
