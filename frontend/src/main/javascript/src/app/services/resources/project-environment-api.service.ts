...
export class ProjectEnvironmentApiService extends BaseApiService {
  ...
  getAll(projectId: number): Observable<ProjectEnvironment[]> {
    return this.http.get(`${environment.apiUrl}/projects/${projectId}/environments`, this.defaultHttpOptions)
      .pipe(
  ...
  create(projectId: number, env: ProjectEnvironment): Observable<ProjectEnvironment> {
    return this.http.post(`${environment.apiUrl}/projects/${projectId}/environments`, env, this.defaultHttpOptions)
      .pipe(
  ...
  delete(projectId: number, env: ProjectEnvironment): Observable<any> {
    return this.http.delete(`${environment.apiUrl}/projects/${projectId}/environments/${env.id}`, this.defaultHttpOptions);
  }

  update(projectId: number, env: ProjectEnvironment): Observable<ProjectEnvironment> {
    return this.http.put(`${environment.apiUrl}/projects/${projectId}/environments/${env.id}`, env, this.defaultHttpOptions)
      .pipe(
        map((body) => ProjectEnvironment.fromData(body))
      );
  }
  ...
  createUrl(projectId: number, envId: number, url: ProjectUrl): Observable<ProjectUrl[]> {
    return this.http.post(`${environment.apiUrl}/projects/${projectId}/environments/${envId}/urls`, url, this.defaultHttpOptions)
      .pipe(
  ...
  deleteUrl(projectId: number, envId: number, url: ProjectUrl): Observable<any> {
    return this.http.delete(`${environment.apiUrl}/projects/${projectId}/environments/${envId}/urls/${url.id}`, this.defaultHttpOptions);
  }

  updateUrl(projectId: number, envId: number, urlId: number, url: ProjectUrl): Observable<ProjectUrl[]> {
    return this.http.put(`${environment.apiUrl}/projects/${projectId}/environments/${envId}/urls/${url.id}`, url, this.defaultHttpOptions)
      .pipe(
        map((body: any) => body.map(e => ProjectUrl.fromData(e)))
      );
  }
  ...
  createVariable(projectId: number, envId: number, variable: ProjectEnvironmentVariable): Observable<ProjectEnvironmentVariable> {
    return this.http.post(`${environment.apiUrl}/projects/${projectId}/environments/${envId}/variables`, variable, this.defaultHttpOptions)
      .pipe(
  ...
  deleteVariable(projectId: number, envId: number, variable: ProjectEnvironmentVariable): Observable<any> {
    return this.http.delete(`${environment.apiUrl}/projects/${projectId}/environments/${envId}/variables/${variable.id}`, this.defaultHttpOptions);
  }
  ...
  updateVariable(projectId: number, envId: number, urlId: number, variable: ProjectEnvironmentVariable): Observable<ProjectEnvironmentVariable> {
    return this.http.put(`${environment.apiUrl}/projects/${projectId}/environments/${envId}/variables/${variable.id}`, variable, this.defaultHttpOptions)
      .pipe(
        map((body) => ProjectEnvironmentVariable.fromData(body))
      );
  }
