...
export class LearnResultResource {
  ...
  getAll(projectId: number): IPromise<any> {
    return this.$http.get(`${env.apiUrl}/projects/${projectId}/results?embed=steps`)
  ...
  get(projectId: number, testNo: number): IPromise<any> {
    return this.$http.get(`${env.apiUrl}/projects/${projectId}/results/${testNo}?embed=steps`)
  ...
  getLatest(projectId: number): IPromise<any> {
    return this.$http.get(`${env.apiUrl}/projects/${projectId}/results/latest`)
  ...
  remove(result: LearnResult): IPromise<any> {
    return this.$http.delete(`${env.apiUrl}/projects/${result.project}/results/${result.testNo}`, {});
  }
  ...
  removeMany(results: LearnResult[]): IPromise<any> {
    ...
    return this.$http.delete(`${env.apiUrl}/projects/${projectId}/results/${testNos}`, {});
  }
  ...
  clone(result: LearnResult): IPromise<any> {
    return this.$http.post(`${env.apiUrl}/projects/${result.project}/results/${result.testNo}/clone`, {})
  ...
  generateTestSuite(projectId: number, testNo: number, config: any): IPromise<any> {
    return this.$http.post(`${env.apiUrl}/projects/${projectId}/results/${testNo}/generateTestSuite`, config)
      .then(res => res.data);
  }
}
