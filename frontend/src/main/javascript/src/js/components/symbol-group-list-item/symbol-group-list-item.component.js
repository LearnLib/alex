 ...
 * otherwise.
 */
class SymbolGroupListItemComponent {
...
export const symbolGroupListItemComponent = {
    template: require('./symbol-group-list-item.component.html'),
    transclude: true,
    controller: SymbolGroupListItemComponent,
    controllerAs: 'vm',
    bindings: {
        group: '='
    }
