...
export class TestResource {
  ...
  abort(projectId: number): IPromise<any> {
    return this.$http.post(`${apiUrl}/projects/${projectId}/tests/abort`, null)
      .then(response => response.data);
  }
  ...
  moveMany(projectId: number, testIds: number[], targetId: number): IPromise<any> {
    return this.$http.put(`${apiUrl}/projects/${projectId}/tests/batch/${testIds.join(',')}/moveTo/${targetId}`, null)
      .then(response => response.data);
  }
