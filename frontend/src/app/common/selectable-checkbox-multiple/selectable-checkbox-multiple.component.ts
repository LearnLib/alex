...
@Component({
  ...
  templateUrl: '../selectable-checkbox/selectable-checkbox.component.html',
  styleUrls: ['../selectable-checkbox/selectable-checkbox.component.scss']
})
export class SelectableCheckboxMultipleComponent {
