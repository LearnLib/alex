...
!function () {
    ...
    }]).run(["$rootScope", "$state", "_", "paths", function (a, b, c, d) {
        a._ = c, a.paths = d, a.$on("$stateChangeSuccess", function (a, c, d, e) {
            b.previous = e
        })
    }])
    ...
    function a(a, b, c, d) {
        ...
        }), a.getDownloadableSymbols = function () {
    ...
    function a(a, b, c, d, e) {
        var f = b.project.get();
        a.symbols = [], a.selectedSymbols = [], a.fileLoaded = function (b) {
            try {
                a.$apply(function () {
                    a.symbols = c.buildSome(angular.fromJson(b))
                })
            } catch (d) {
                e.danger("<p><strong>Loading json file failed</strong></p>" + d)
            }
        }, a.uploadSelectedSymbols = function () {
            if (a.selectedSymbols.length > 0) {
                var b = angular.copy(a.selectedSymbols);
                d.forEach(b, function (a) {
                    delete a._collapsed, delete a._selected
                }), c.Resource.createSome(f.id, b).then(function (b) {
                    d.forEach(b, function (b) {
                        d.remove(a.symbols, {name: b.name})
                    })
                })["catch"](function (a) {
                    e.danger("<p><strong>Symbol upload failed</strong></p>" + a.data.message)
                })
            }
        }
    }

    angular.module("weblearner.controller").controller("SymbolsImportController", a), a.$inject = ["$scope", "SessionService", "Symbol", "_", "ToastService"]
}(), function () {
    "use strict";
    function a(a, b, c, d, e) {
        var f = b.project.get();
        ...
        function b(b, c) {
            c.on("click", function () {
                if (angular.isDefined(b.data)) {
                    var c = b.data;
                    angular.isFunction(b.data) && (c = b.data()), a.downloadJson(c)
                }
            })
        }
    ...
    function a() {
        function a(a, b) {
            ...
            d.onload = function (b) {
                angular.isDefined(a.onLoaded) && a.onLoaded()(b.target.result)
        ...
        return {restrict: "A", scope: {onLoaded: "&"}, link: a}
    }
    ...
    angular.module("weblearner.directives").directive("fixOnScroll", a), a.$inject = ["$window"]
}(), function () {
    "use strict";
    function a(a, b, c) {
        function d(d, e) {
            ...
            e.on("click", function () {
                f = b("<html-element-picker-window></html-element-picker-window>")(d), a.find("body").prepend(f), c.open().then(function (a) {
                    angular.isDefined(d.selectorModel) && (d.selectorModel = a.xPath), angular.isDefined(d.textModel) && (d.textModel = a.textContent)
                })["finally"](function () {
                    f.remove()
                })
            })
        ...
        return {restrict: "A", scope: {selectorModel: "=model", textModel: "=text"}, link: d}
    }
    ...
    function c(a, b, c, d) {
        function e(e, f) {
            ...
            function h(a) {
                return m == a.target ? !1 : (null != m && (m.style.outline = "0px"), m = a.target, m.style.outline = "5px solid red", e.selector = g(m), e.textContent = "input" === m.nodeName.toLowerCase() ? m.value : m.textContent, void e.$apply())
            }

            function i(a) {
                angular.isDefined(a) && (a.preventDefault(), a.stopPropagation()), m.style.outline = "0px", m = null, p = !1, angular.element(l.contents()[0].body).off("mousemove", h), angular.element(l.contents()[0].body).off("click", i), angular.element(document.body).off("keyup", j)
            }
            ...
            var l = f.find("iframe"), m = null, n = null, o = null, p = !1;
            e.selector = null, e.textContent = null, e.url = null, e.loadUrl = function () {
                ...
                a.on("mousemove", h), a.one("click", i), angular.element(document.body).on("keyup", j), p = !0
            }, e.close = function () {
                d.setUrl(e.url), d.close()
            }, e.ok = function () {
                d.setUrl(e.url), d.close({xPath: e.selector, textContent: e.textContent})
            }, k()
        }

        return {restrict: "E", scope: {}, templateUrl: c.views.DIRECTIVES + "/html-element-picker.html", link: e}
    }
    ...
    function d(a, c, d, e, f, g, h) {
        function i(c, i) {
            ...
            function k() {
                i.find("svg")[0].innerHTML = ""
            }

            function l() {
                r = g.select(i.find("svg")[0]), s = r.append("g"), t = r.node().parentNode, u = new h.Graph({
                    directed: !0,
                    multigraph: !0
                }), u.setGraph(angular.isDefined(c.layoutSettings) ? {
            ...
            function m() {
                angular.isDefined(c.layoutSettings) && c.layoutSettings.multigraph ? n() : o()
            }

            function n() {
                e.forEach(c.test.hypothesis.nodes, function (a, b) {
                    var d = {
                        shape: "circle",
                        label: a.toString(),
                        width: 25,
                    ...
                    d.style = a === c.test.hypothesis.initNode ? "fill: #B3E6B3; stroke: #5cb85c; stroke-width: 3" : "fill: #fff; stroke: #000; stroke-width: 1", u.setNode("" + b, d)
                }), e.forEach(c.test.hypothesis.edges, function (a, b) {
                    var c = a.from + "-" + a.to + "|" + b;
                    u.setEdge(a.from, a.to, {
            ...
            function o() {
                ...
                e.forEach(c.test.hypothesis.nodes, function (a, b) {
                    ...
                    d.style = a === c.test.hypothesis.initNode ? "fill: #B3E6B3; stroke: #5cb85c; stroke-width: 3" : "fill: #fff; stroke: #000; stroke-width: 1", u.setNode("" + b, d)
                }), e.forEach(c.test.hypothesis.edges, function (b) {
            ...
            function p() {
                (v = new f.render)(s, u);
                var a = (t.clientWidth - u.graph().width) / 2;
                s.attr("transform", "translate(" + a + ", 100)")
            }

            function q() {
                function f() {
                    s.attr("transform", "translate(" + k.translate() + ") scale(" + k.scale() + ")")
                }

                function h() {
                    g.event.sourceEvent.stopPropagation()
                }

                function i(a) {
                    var c = g.select(this), d = u.node(a);
                    d.x += g.event.dx, d.y += g.event.dy, c.attr("transform", "translate(" + d.x + "," + d.y + ")");
                    var f = g.selectAll(".path");
                    e.forEach(u.edges(), function (a, c) {
                        var d = b(u, a);
                        f[0][c].setAttribute("d", d)
                    })
                }

                function j() {
                    r.attr("width", t.clientWidth), r.attr("height", t.clientHeight)
                }

                var k, i;
                angular.isDefined(c.isSelectable) && r.selectAll(".edgeLabel tspan").on("click", function () {
                    var a = this.innerHTML.split("/");
                    c.$apply(function () {
                        d.addIOPairToCurrentCounterexample(a[0], a[1])
                    })
                }), k = g.behavior.zoom().scaleExtent([.1, 10]).translate([(t.clientWidth - u.graph().width) / 2, 100]).on("zoom", f), k(r), i = g.behavior.drag().origin(function (a) {
                    return a
                }).on("dragstart", h).on("drag", i), r.selectAll(".node").attr("cx", function (a) {
                    return a.x
                }).attr("cy", function (a) {
                    return a.y
                }).call(i), angular.element(a).on("resize", j), window.setTimeout(function () {
                    window.dispatchEvent(new Event("resize"))
                }, 100)
            }
            ...
            c.$watch("test", function (a) {
                angular.isDefined(a) && null != a && j()
            }), c.$watch("layoutSettings", function (a) {
                angular.isDefined(a) && j()
            })
        }
    ...
    angular.module("weblearner.directives").directive("hypothesis", d), d.$inject = ["$window", "paths", "CounterExampleService", "_", "dagreD3", "d3", "graphlib"]
}(), function () {
    "use strict";
    function a(a, b) {
        function c(c, d) {
    ...
    function a(a, b) {
        function c(c, d) {
            d.on("click", function () {
                ...
                d.result.then(function (a) {
                    angular.isDefined(c.onOk) && c.onOk()(a)
                })
            })
        }
    ...
    function a(a, b, c) {
        function d(a, d) {
            function e(a) {
                a.stopPropagation(), g.toggleClass(h)
            }

            var f = angular.element(d[0].getElementsByClassName("navbar-menu-handle")), g = angular.element(d[0].getElementsByClassName("navbar-offscreen")), h = "show";
            a.project = c.project.get(), function () {
                f.on("click", e), a.$on("project.opened", function () {
                    a.project = c.project.get()
                }), a.$on("project.closed", function () {
                    a.project = null
                })
            }(), a.closeProject = function () {
                c.project.remove(), b.go("home")
            }
        }

        return {scope: {}, templateUrl: a.views.DIRECTIVES + "/navigation.html", link: d}
    }

    angular.module("weblearner.directives").directive("navigation", a), a.$inject = ["paths", "$state", "SessionService"]
}(), function () {
    "use strict";
    function a(a) {
        function b(a) {
            function b() {
                var b = a.data.split("\n"), c = 0;
                if (b.length > 1)for (var d = 0; d < b.length - 1; d++)if (new RegExp("^(\\+\\=+)+\\+$").test(b[d]))c++; else if (d % 2 === 1) {
                    b[d] = b[d].split("|"), b[d].shift(), b[d].pop();
                    for (var e = 0; e < b[d].length; e++)b[d][e] = b[d][e].trim();
                    1 === d ? a.table.header = b[d] : 2 === c ? a.table.body.s1.push(b[d]) : a.table.body.s2.push(b[d])
                }
            }

            a.table = {header: [], body: {s1: [], s2: []}}, a.$watch("data", function (a) {
                angular.isDefined(a) && b()
            })
        }

        return {restrict: "E", scope: {data: "="}, link: b, templateUrl: a.views.DIRECTIVES + "/observation-table.html"}
    }
    ...
    function a() {
        ...
        return {restrict: "A", scope: {items: "&"}, link: a}
    }
    ...
    function a(a, b) {
        ...
        return {restrict: "A", scope: {projectId: "@", onCreated: "&"}, link: c}
    }
    ...
    function a(a, b) {
        ...
        return {scope: {projectId: "@", onCreated: "&"}, link: c}
    }
    ...
    function a(a, b) {
        ...
        return {restrict: "A", scope: {group: "=", onUpdated: "&", onDeleted: "&"}, link: c}
    }
    ...
    function a(a, b) {
        ...
        return {scope: {symbols: "=", groups: "=", onMoved: "&"}, link: c}
    }
    ...
    function a(a, b) {
        function c(c, d) {
            d.on("click", function () {
                a.open({
                    templateUrl: b.views.MODALS + "/variables-counters-occurrence-modal.html",
    ...
    angular.module("weblearner.directives").directive("variablesCountersOccurrenceModalHandle", a), a.$inject = ["$modal", "paths"]
}(),function () {
    "use strict";
    function a(a) {
        return {
            ...
            transclude: !0,
            templateUrl: a.views.DIRECTIVES + "/view-heading.html"
        }
    }
    ...
    function a(a) {
        ...
        return b.Web = function () {
        ...
        }, b.Web.ClickLinkByText = function (c) {
            b.call(this, a.web.CLICK_LINK_BY_TEXT), this.value = c || null
        }, b.Web.ClickLinkByText.prototype.toString = function () {
            ...
            switch (c.type) {
                ...
                case a.web.CLICK:
                    ...
                    break;
                case a.web.CLICK_LINK_BY_TEXT:
                    d = new b.Web.ClickLinkByText(c.value);
                    break;
                case a.web.FILL:
    ...
    function a(a) {
        ...
        function d(b) {
            this.type = a.SAMPLE, this.counterExamples = b || []
        }
    ...
    function a(a, b) {
        ...
        return {getAll: c, "delete": d, deleteSome: e}
    }
    ...
    function a(a) {
        ...
        function d(a) {
            c("JSON").then(function (c) {
                var d = "data:text/json;charset=utf-8," + encodeURIComponent(angular.toJson(a));
                b(c, "json", d)
            })
        }
        ...
        function f(a) {
            c("SVG").then(function (c) {
                ...
                var d = (new XMLSerializer).serializeToString(a), e = "data:image/svg+xml;base64,\n" + window.btoa(d);
                b(c, "svg", e)
            })
        }
