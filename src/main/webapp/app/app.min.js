...
!function(){"use strict";angular.module("weblearner",["ngAnimate","ui.sortable","ui.bootstrap","ui.ace","ui.router","ngToast","draganddrop","templates-all","weblearner.controller","weblearner.resources","weblearner.directives","weblearner.services","weblearner.filters","weblearner.routes","weblearner.constants","weblearner.models"]),angular.module("weblearner.controller",[]),angular.module("weblearner.resources",[]),angular.module("weblearner.directives",[]),angular.module("weblearner.services",[]),angular.module("weblearner.filters",[]),angular.module("weblearner.routes",["weblearner.constants","templates-all","ui.router"]),angular.module("weblearner.constants",[]),angular.module("weblearner.models",[]),angular.module("weblearner").config(["ngToastProvider",function(a){a.configure({verticalPosition:"top",horizontalPosition:"center",maxNumber:1})}]).run(["$rootScope","_","SelectionService",function(a,b,c){a._=b,a.selection=c}])}(),angular.module("templates-all",["app/views/directives/counter-example-builder.html","app/views/directives/hypothesis-panel.html","app/views/directives/hypothesis.html","app/views/directives/load-screen.html","app/views/directives/navigation.html","app/views/directives/observation-table.html","app/views/directives/rest-action-create-form.html","app/views/directives/rest-action-edit-form.html","app/views/directives/web-action-create-form.html","app/views/directives/web-action-edit-form.html","app/views/directives/web-element-picker.html","app/views/modals/action-create-modal.html","app/views/modals/action-edit-modal.html","app/views/modals/hypothesis-layout-settings-modal.html","app/views/modals/modal-confirm-dialog.html","app/views/modals/modal-prompt-dialog.html","app/views/modals/modal-test-details.html","app/views/modals/modal-test-setup-settings.html","app/views/modals/symbol-create-modal.html","app/views/modals/symbol-edit-modal.html","app/views/modals/symbol-group-create-modal.html","app/views/modals/symbol-group-edit-modal.html","app/views/modals/symbol-move-modal.html","app/views/pages/about.html","app/views/pages/groups.html","app/views/pages/help.html","app/views/pages/home.html","app/views/pages/learn-results-compare.html","app/views/pages/learn-results-statistics.html","app/views/pages/learn-results.html","app/views/pages/learn-setup.html","app/views/pages/learn-start.html","app/views/pages/project-create.html","app/views/pages/project-settings.html","app/views/pages/project.html","app/views/pages/symbols-actions.html","app/views/pages/symbols-export.html","app/views/pages/symbols-history.html","app/views/pages/symbols-import.html","app/views/pages/symbols-trash.html","app/views/pages/symbols.html","app/views/pages/tools-hypotheses-view.html","app/views/widgets/widget-counter-examples.html","app/views/widgets/widget-test-resume-settings.html"]),angular.module("app/views/directives/counter-example-builder.html",[]).run(["$templateCache",function(a){"use strict";a.put("app/views/directives/counter-example-builder.html",'<div id="counter-example-builder">\n	<div class="wrapper">\n	\n		<nav class="navbar navbar-default" role="navigation">\n	        <div class="container-fluid">\n	        \n	        	<p class="navbar-text"><strong>Counter Example Builder</strong></p>\n	        \n	            <button class="btn btn-default navbar-btn pull-right" ng-click="close()"><i\n	                    class="fa fa-close"></i></button>\n	            <button class="btn btn-primary navbar-btn pull-right" ng-click="ok()" style="margin-right: 7px">ok</button>\n	            <button class="btn btn-default navbar-btn pull-right" ng-click="ok()" style="margin-right: 7px">\n	            	<i class="fa fa-eye"></i>\n	            </button>  \n	        </div>\n	    </nav>\n	    \n	    <div class="available-inputs-panel">\n	        <ul class="list-group">\n	            <li class="list-group-item" ng-repeat="input in inputs" draggable="true" effect-allowed="copy"\n	                draggable-type="custom-object" draggable-data="input">{{input}}</li>\n	        </ul>\n	    </div>\n    \n    <div class="counter-example-panel">\n\n		<div class="counter-example-list-wrapper">\n            <div class="list-group" as-sortable ng-model="ios">\n                <div class="list-group-item" ng-repeat="io in counterExample track by $index" as-sortable-item>\n\n                    <span class="text-muted pull-right" ng-click="remove($index)">\n                        <i class="fa fa-trash fa-fw"></i>\n                    </span>\n\n                    <span class="text-muted pull-right" as-sortable-item-handle style="display: inline-block; margin-right: 5px">\n                        <i class="fa fa-sort fa-fw"></i>\n                    </span>\n\n                    <div class="container-fluid clearfix" style="margin-right: 50px; padding: 0">\n\n                        <div style="width: 66%; float: left" drop="onDropInput($data, $event, $index)" drop-effect="copy"\n                             drop-accept="\'json/custom-object\'">\n                            <div class="counter-example-input">{{io.input}}</div>\n                        </div>\n\n                        <div style="width: 34%; float: left">\n                            <select class="form-control">\n                            	<option>OK</option>\n                            	<option>FAILED</option>\n                            </select>\n                        </div>\n\n                    </div>\n\n                </div>\n        	</div>\n        	\n        	<button class="btn btn-default btn-sm btn-block" ng-click="add()">\n	            Add\n	        </button>\n    	</div>\n		\n    </div>\n				\n	</div>\n</div>')}]),angular.module("app/views/directives/hypothesis-panel.html",[]).run(["$templateCache",function(a){"use strict";a.put("app/views/directives/hypothesis-panel.html",'<div class="hypothesis-panel-container">\n\n    <!-- BEGIN: Subnavigation -->\n    <div class="sub-nav absolute">\n        <div class="container-fluid">\n            <div class="pull-left" style="margin-right: 16px">\n                <div class="btn-group btn-group-xs" dropdown>\n                    <button type="button" class="btn btn-default dropdown-toggle" dropdown-toggle>\n                        <i class="fa fa-bars"></i>\n                    </button>\n                    <ul class="dropdown-menu pull-left" role="menu">\n                        <li>\n                            <a href="" open-test-details-modal test="getCurrentStep()">\n                                <i class="fa fa-info fa-fw"></i> Details\n                            </a>\n                        </li>\n                        <li class="divider"></li>\n                        <li>\n                            <a href="" download-hypothesis-as-svg="#hypothesis-{{index}}">\n                                <i class="fa fa-save fa-fw"></i>&nbsp; Save as *.svg\n                            </a>\n                            <a href="" download-as-json data="getCurrentStep().hypothesis">\n                                <i class="fa fa-save fa-fw"></i>&nbsp; Save as *.json\n                            </a>\n                        </li>\n                    </ul>\n                </div>\n                \n                <button class="btn btn-default btn-xs" open-hypothesis-layout-settings-modal layout-settings="layoutSettings[index]">\n                     	<i class="fa fa-eye fa-fw"></i> Layout\n                </button>\n            </div>\n            <div class="pull-right">\n\n                <div class="btn-group btn-group-xs">\n                    <button class="btn btn-default" ng-click="firstStep()">\n                        <i class="fa fa-angle-double-left fa-fw"></i>\n                    </button>\n                    <button class="btn btn-default" ng-click="previousStep()">\n                        <i class="fa fa-angle-left fa-fw"></i>\n                    </button>\n                    <button class="btn btn-default disabled">\n                        <span ng-bind="pointer + 1"></span>/<span ng-bind="result.length"></span>\n                    </button>\n                    <button class="btn btn-default" ng-click="nextStep()">\n                        <i class="fa fa-angle-right fa-fw"></i>\n                    </button>\n                    <button class="btn btn-default" ng-click="lastStep()">\n                        <i class="fa fa-angle-double-right fa-fw"></i>\n                    </button>\n                </div>\n\n                <button class="btn btn-xs btn-danger" panel-close-button="{{index}}">\n                    <i class="fa fa-close"></i>\n                </button>\n\n            </div>\n        </div>\n    </div>\n    <!-- END: Subnavigation -->\n\n    <div class="hypothesis-panel">\n\n        <hypothesis id="hypothesis-{{index}}" test="getCurrentStep()" layout-settings="layoutSettings[index]"></hypothesis>\n\n    </div>\n\n</div>')}]),angular.module("app/views/directives/hypothesis.html",[]).run(["$templateCache",function(a){"use strict";a.put("app/views/directives/hypothesis.html",'<div style="position: absolute; top: 0; width: 100%; bottom: 0; overflow: hidden; background: #fff;">\n    <svg class="hypothesis"></svg>\n</div>')}]),angular.module("app/views/directives/load-screen.html",[]).run(["$templateCache",function(a){"use strict";a.put("app/views/directives/load-screen.html",'<div id="load-screen">\n    <p class="text-center" id="load-screen-indicator">\n        <i class="fa fa-spin fa-3x fa-circle-o-notch"></i>\n    </p>\n</div>')}]),angular.module("app/views/directives/navigation.html",[]).run(["$templateCache",function(a){"use strict";a.put("app/views/directives/navigation.html",'<nav class="navbar navbar-application navbar-fixed-top" role="navigation">\n\n    <div class="container-fluid">\n\n        <div class="navbar-header">\n            <a class="navbar-brand" ui-sref="home"><strong>Wl</strong></a>\n        </div>\n\n        <ul class="nav navbar-nav navbar-left navbar-menu-handle">\n            <li>\n                <a href="#">\n                    <i class="fa fa-fw fa-bars"></i> Menu\n                </a>\n            </li>\n        </ul>\n\n        <div class="navbar-offscreen">\n\n            <div class="navbar-offscreen-header">\n                <a href class="pull-right navbar-menu-handle">\n                    <i class="fa fa-close" style="color: #fff"></i>\n                </a>\n            </div>\n\n            <div ng-if="!project">\n\n                <ul class="nav navbar-nav navbar-left">\n                    <li class="dropdown" dropdown dropdown-navigation>\n                        <a href="#" dropdown-toggle class="dropdown-toggle" data-toggle="dropdown" role="button"\n                           aria-expanded="false">\n                            <span>Project</span>\n                            <span class="caret"></span>\n                        </a>\n                        <ul class="dropdown-menu" role="menu" ng-if="!project">\n                            <li><a ui-sref="project.create">Create a new project</a></li>\n                        </ul>\n                    </li>\n                </ul>\n\n            </div>\n\n            <div ng-if="project">\n\n                <ul class="nav navbar-nav navbar-left">\n                    <li class="dropdown" dropdown dropdown-navigation>\n                        <a href="#" dropdown-toggle class="dropdown-toggle" data-toggle="dropdown" role="button"\n                           aria-expanded="false">\n                            <strong ng-bind="project.name"></strong>\n                            <span class="caret"></span>\n                        </a>\n                        <ul class="dropdown-menu" role="menu" ng-if="project">\n                            <li><a class="disabled" ui-sref="project">Overview</a></li>\n                            <li><a ui-sref="project.settings">Settings</a></li>\n                            <li class="divider"></li>\n                            <li><a href="#/" ng-click="closeProject()">Close</a></li>\n                        </ul>\n                    </li>\n                </ul>\n\n                <ul class="nav navbar-nav navbar-left">\n                    <li class="dropdown" dropdown dropdown-navigation>\n                        <a href="#" dropdown-toggle class="dropdown-toggle" data-toggle="dropdown" role="button"\n                           aria-expanded="false">Symbols <span class="caret"></span></a>\n                        <ul class="dropdown-menu" role="menu">\n                            <li><a ui-sref="symbols">Manage Symbols</a></li>\n                            <li class="divider"></li>\n                            <li><a ui-sref="symbols.import">Import</a></li>\n                            <li><a ui-sref="symbols.export">Export</a></li>\n                        </ul>\n                    </li>\n                </ul>\n\n                <ul class="nav navbar-nav navbar-left">\n                    <li>\n                        <a href="#" ui-sref="learn.setup" role="button"\n                           aria-expanded="false">Learn </a>\n                    </li>\n                </ul>\n\n                <ul class="nav navbar-nav navbar-left">\n                    <li class="dropdown" dropdown dropdown-navigation>\n                        <a href="#" dropdown-toggle class="dropdown-toggle" data-toggle="dropdown" role="button"\n                           aria-expanded="false">Results <span class="caret"></span></a>\n                        <ul class="dropdown-menu" role="menu">\n                            <li><a ui-sref="learn.results">View & Compare</a></li>\n                            <li class="divider"></li>\n                            <li><a ui-sref="learn.results.statistics">Statistics</a></li>\n                        </ul>\n                    </li>\n                </ul>\n\n            </div>\n\n            <ul class="nav navbar-nav navbar-right">\n                <li class="dropdown" dropdown dropdown-navigation>\n                    <a href="#" dropdown-toggle class="dropdown-toggle" data-toggle="dropdown" role="button"\n                       aria-expanded="false">App <span class="caret"></span></a>\n                    <ul class="dropdown-menu" role="menu">\n                        <li><a ui-sref="about">About</a></li>\n                        <li><a ui-sref="help">Help</a></li>\n                    </ul>\n                </li>\n            </ul>\n\n            <ul class="nav navbar-nav navbar-right" ng-if="!project">\n                <li class="dropdown" dropdown dropdown-navigation>\n                    <a href="#" dropdown-toggle class="dropdown-toggle" data-toggle="dropdown" role="button"\n                       aria-expanded="false">Tools <span class="caret"></span></a>\n                    <ul class="dropdown-menu" role="menu">\n                        <li><a ui-sref="tools.hypotheses">View Hypothesis from PC</a></li>\n                    </ul>\n                </li>\n            </ul>\n\n        </div>\n\n    </div>\n\n</nav>\n')}]),angular.module("app/views/directives/observation-table.html",[]).run(["$templateCache",function(a){"use strict";a.put("app/views/directives/observation-table.html","")}]),angular.module("app/views/directives/rest-action-create-form.html",[]).run(["$templateCache",function(a){"use strict";a.put("app/views/directives/rest-action-create-form.html",'<form id="rest-action-create-form" ng-submit="submitForm()">\n\n    <select class="form-control" ng-model="action.type" ng-options="k for (k,v) in actionTypes">\n        <option value="" disabled>Select an action you want to create</option>\n    </select>\n\n    <p></p>\n\n    <!-- BEGIN: CALL_URL -->\n    <div ng-if="action.type == actionTypes.CALL_URL">\n        <p class="text-muted">Make a HTTP request to an URL (relative to your projects base url)</p>\n        <div class="form-group">\n            <input class="form-control" type="text" placeholder="url" ng-model="action.url">\n        </div>\n        <div class="form-group">\n            <select class="form-control" ng-options="m for m in [\'DELETE\', \'GET\', \'POST\', \'PUT\']" ng-model="action.method">\n                <option value="" disabled>Select a Method</option>\n            </select>\n        </div>\n        <div class="form-group">\n            <label>Data</label>\n            <div ng-model="action.data" style="border-radius: 4px; width: 100%; height: 150px; border: 1px solid #ccc" ui-ace="{useWrapMode : true, showGutter: true, theme:\'eclipse\', mode: \'json\'}"></div>\n        </div>\n    </div>\n    <!-- END: CALL_URL -->\n\n\n    <!-- BEGIN: CHECK_ATTRIBUTE_EXISTS -->\n    <div ng-if="action.type == actionTypes.CHECK_ATTRIBUTE_EXISTS">\n        <p class="text-muted">Check if a JSON attribute exists in the response body</p>\n        <div class="form-group">\n            <input class="form-control" type="text" placeholder="json attribute, e.g. myobj.attr[1].obj" ng-model="action.attribute">\n        </div>\n    </div>\n    <!-- END: CHECK_ATTRIBUTE_EXISTS -->\n\n\n    <!-- BEGIN: CHECK_ATTRIBUTE_TYPE -->\n    <div ng-if="action.type == actionTypes.CHECK_ATTRIBUTE_TYPE">\n        <p class="text-muted">Check if a JSON attribute in the response body has a specific type</p>\n        <div class="form-group">\n            <input class="form-control" type="text" placeholder="json attribute, e.g. myobj.attr[1].obj" ng-model="action.attribute">\n        </div>\n        <div class="form-group">\n            <select class="form-control" ng-model="action.jsonType" ng-options="t as t for t in [\'ARRAY\', \'BOOLEAN\', \'INTEGER\', \'OBJECT\', \'NULL\', \'STRING\']">\n                <option value="" disabled>Choose a JavaScript type</option>\n            </select>\n        </div>\n    </div>\n    <!-- END: CHECK_ATTRIBUTE_TYPE -->\n\n\n    <!-- BEGIN: CHECK_ATTRIBUTE_VALUE -->\n    <div ng-if="action.type == actionTypes.CHECK_ATTRIBUTE_VALUE">\n        <p class="text-muted">Check a JSON attribute of the response body to be a specific value</p>\n        <div class="form-group">\n            <input class="form-control" type="text" placeholder="json attribute, e.g. myobj.attr[1].obj" ng-model="action.attribute">\n        </div>\n        <div class="form-group">\n            <input class="form-control" type="text" placeholder="the attribute value" ng-model="action.value">\n        </div>\n        <div class="checkbox">\n            <label>\n                <input type="checkbox" ng-model="action.regexp"> is regular expression\n            </label>\n        </div>\n    </div>\n    <!-- END: CHECK_ATTRIBUTE_VALUE -->\n\n\n    <!-- BEGIN: CHECK_HEADER_FIELD -->\n    <div ng-if="action.type == actionTypes.CHECK_HEADER_FIELD">\n        <p class="text-muted">Check a HTTP response header field to have a specific value</p>\n        <div class="form-group">\n            <input class="form-control" type="text" placeholder="http header field, e.g. Content-Type" ng-model="action.key">\n        </div>\n        <div class="form-group">\n            <input class="form-control" type="text" placeholder="http header field value, e.g. application/json" ng-model="action.value">\n        </div>\n        <div class="checkbox">\n            <label>\n                <input type="checkbox" ng-model="action.regexp">is regular expression\n            </label>\n        </div>\n    </div>\n    <!-- END: CHECK_HEADER_FIELD -->\n\n\n    <!-- BEGIN: CHECK_HTTP_BODY_TEXT -->\n    <div ng-if="action.type == actionTypes.CHECK_HTTP_BODY_TEXT">\n        <p class="text-muted">Search for a string or a regular express in the response body of a request</p>\n        <div class="form-group">\n            <input class="form-control" type="text" placeholder="value to search for" ng-model="action.value">\n        </div>\n        <div class="checkbox">\n            <label>\n                <input type="checkbox" ng-model="action.regexp">\n                is regular expression\n            </label>\n        </div>\n    </div>\n    <!-- END: CHECK_HTTP_BODY_TEXT -->\n\n\n    <!-- BEGIN: CHECK_STATUS -->\n    <div ng-if="action.type == actionTypes.CHECK_STATUS">\n        <p class="text-muted">Check the HTTP response to have a specific status</p>\n        <div class="form-group">\n            <input class="form-control" type="number" placeholder="e.g. 200, 404 ..." ng-model="action.status">\n        </div>\n    </div>\n    <!-- END: CHECK_STATUS -->\n\n    <div ng-if="action.type">\n        <hr>\n        <button class="btn btn-primary btn-sm" type="submit">Create Action</button>\n    </div>\n\n</form>')}]),angular.module("app/views/directives/rest-action-edit-form.html",[]).run(["$templateCache",function(a){"use strict";a.put("app/views/directives/rest-action-edit-form.html",'<form id="rest-action-update-form" ng-submit="submitForm()">\n\n    <!-- BEGIN: CALL_URL -->\n    <div ng-if="action.type == actionTypes.CALL_URL">\n        <p class="text-muted">Make a HTTP request to an URL (relative to your projects base url)</p>\n        <div class="form-group">\n            <input class="form-control" type="text" placeholder="url" ng-model="action.url">\n        </div>\n        <div class="form-group">\n            <select class="form-control" ng-options="m for m in [\'DELETE\', \'GET\', \'POST\', \'PUT\']" ng-model="action.method">\n                <option value="" disabled>Select a Method</option>\n            </select>\n        </div>\n        <div class="form-group">\n            <label>Data</label>\n            <div ng-model="action.data" style="border-radius: 4px; width: 100%; height: 150px; border: 1px solid #ccc" ui-ace="{useWrapMode : true, showGutter: true, theme:\'eclipse\', mode: \'json\'}"></div>\n        </div>\n    </div>\n    <!-- END: CALL_URL -->\n\n\n    <!-- BEGIN: CHECK_ATTRIBUTE_EXISTS -->\n    <div ng-if="action.type == actionTypes.CHECK_ATTRIBUTE_EXISTS">\n        <p class="text-muted">Check if a JSON attribute exists in the response body</p>\n        <div class="form-group">\n            <input class="form-control" type="text" placeholder="json attribute, e.g. myobj.attr[1].obj" ng-model="action.attribute">\n        </div>\n    </div>\n    <!-- END: CHECK_ATTRIBUTE_EXISTS -->\n\n\n    <!-- BEGIN: CHECK_ATTRIBUTE_TYPE -->\n    <div ng-if="action.type == actionTypes.CHECK_ATTRIBUTE_TYPE">\n        <p class="text-muted">Check if a JSON attribute in the response body has a specific type</p>\n        <div class="form-group">\n            <input class="form-control" type="text" placeholder="json attribute, e.g. myobj.attr[1].obj" ng-model="action.attribute">\n        </div>\n        <div class="form-group">\n            <select class="form-control" ng-model="action.jsonType" ng-options="t as t for t in [\'ARRAY\', \'BOOLEAN\', \'INTEGER\', \'OBJECT\', \'NULL\', \'STRING\']">\n                <option value="" disabled>Choose a JavaScript type</option>\n            </select>\n        </div>\n    </div>\n    <!-- END: CHECK_ATTRIBUTE_TYPE -->\n\n\n    <!-- BEGIN: CHECK_ATTRIBUTE_VALUE -->\n    <div ng-if="action.type == actionTypes.CHECK_ATTRIBUTE_VALUE">\n        <p class="text-muted">Check a JSON attribute of the response body to be a specific value</p>\n        <div class="form-group">\n            <input class="form-control" type="text" placeholder="json attribute, e.g. myobj.attr[1].obj" ng-model="action.attribute">\n        </div>\n        <div class="form-group">\n            <input class="form-control" type="text" placeholder="the attribute value" ng-model="action.value">\n        </div>\n        <div class="checkbox">\n            <label>\n                <input type="checkbox" ng-model="action.regexp"> is regular expression\n            </label>\n        </div>\n    </div>\n    <!-- END: CHECK_ATTRIBUTE_VALUE -->\n\n\n    <!-- BEGIN: CHECK_HEADER_FIELD -->\n    <div ng-if="action.type == actionTypes.CHECK_HEADER_FIELD">\n        <p class="text-muted">Check a HTTP response header field to have a specific value</p>\n        <div class="form-group">\n            <input class="form-control" type="text" placeholder="http header field, e.g. Content-Type" ng-model="action.key">\n        </div>\n        <div class="form-group">\n            <input class="form-control" type="text" placeholder="http header field value, e.g. application/json" ng-model="action.value">\n        </div>\n        <div class="checkbox">\n            <label>\n                <input type="checkbox" ng-model="action.regexp">is regular expression\n            </label>\n        </div>\n    </div>\n    <!-- END: CHECK_HEADER_FIELD -->\n\n\n    <!-- BEGIN: CHECK_HTTP_BODY_TEXT -->\n    <div ng-if="action.type == actionTypes.CHECK_HTTP_BODY_TEXT">\n        <p class="text-muted">Search for a string or a regular express in the response body of a request</p>\n        <div class="form-group">\n            <input class="form-control" type="text" placeholder="value to search for" ng-model="action.value">\n        </div>\n        <div class="checkbox">\n            <label>\n                <input type="checkbox" ng-model="action.regexp">\n                is regular expression\n            </label>\n        </div>\n    </div>\n    <!-- END: CHECK_HTTP_BODY_TEXT -->\n\n\n    <!-- BEGIN: CHECK_STATUS -->\n    <div ng-if="action.type == actionTypes.CHECK_STATUS">\n        <p class="text-muted">Check the HTTP response to have a specific status</p>\n        <div class="form-group">\n            <input class="form-control" type="number" placeholder="e.g. 200, 404 ..." ng-model="action.status">\n        </div>\n    </div>\n    <!-- END: CHECK_STATUS -->\n\n    <hr>\n    <button class="btn btn-primary btn-sm" type="submit">Update Action</button>\n\n</form>')}]),angular.module("app/views/directives/web-action-create-form.html",[]).run(["$templateCache",function(a){"use strict";a.put("app/views/directives/web-action-create-form.html",'<form id="web-action-create-form" ng-submit="submitForm()">\n\n    <select class="form-control" ng-model="action.type" ng-options="k for (k,v) in actionTypes">\n        <option value="" disabled>Select an action you want to create</option>\n    </select>\n\n    <p></p>\n\n    <!-- BEGIN: SEARCH_FOR_TEXT -->\n    <div ng-if="action.type == actionTypes.SEARCH_FOR_TEXT">\n        <p class="text-muted">\n            Search on a page for a piece of text or a regular expression\n        </p>\n        <div class="form-group">\n            <label class="control-label">Value</label>\n            <input class="form-control" type="text" placeholder="value" ng-model="action.value">\n        </div>\n        <div class="checkbox">\n            <label>\n                <input type="checkbox" ng-model="action.regexp"> Use Regular Expression\n            </label>\n        </div>\n        <button class="btn btn-default btn-sm" open-web-element-picker url="action.url" selector="action.value">\n            <i class="fa fa-magic fa-fw"></i>&nbsp; WebPicker\n        </button>\n    </div>\n    <!-- END: SEARCH_FOR_TEXT -->\n\n\n    <!-- BEGIN: SEARCH_FOR_NODE -->\n    <div ng-if="action.type == actionTypes.SEARCH_FOR_NODE">\n        <p class="text-muted">\n            Search an HTML element in the DOM tree of a page\n        </p>\n\n        <div class="form-group">\n            <label class="control-label">CSS selector</label>\n            <input class="form-control" type="text" placeholder="CSS selector" ng-model="action.value">\n        </div>\n\n        <button class="btn btn-default btn-sm" open-web-element-picker url="action.url" selector="action.value">\n            <i class="fa fa-magic fa-fw"></i>&nbsp; WebPicker\n        </button>\n    </div>\n    <!-- END: SEARCH_FOR_NODE -->\n\n\n    <!-- BEGIN: CLEAR -->\n    <div ng-if="action.type == actionTypes.CLEAR">\n        <p class="text-muted">\n            Clear an element (eg. input or contenteditable element)\n        </p>\n\n        <div class="form-group">\n            <label class="control-label">CSS selector</label>\n            <input class="form-control" type="text" placeholder="CSS selector" ng-model="action.node">\n        </div>\n\n        <button class="btn btn-default btn-sm" open-web-element-picker url="action.url" selector="action.node">\n            <i class="fa fa-magic fa-fw"></i>&nbsp; WebPicker\n        </button>\n    </div>\n    <!-- END: CLEAR -->\n\n\n    <!-- BEGIN: CLICK -->\n    <div ng-if="action.type == actionTypes.CLICK">\n        <p class="text-muted">\n            Click on an element\n        </p>\n\n        <div class="form-group">\n            <label class="control-label">CSS selector</label>\n            <input class="form-control" type="text" placeholder="CSS selector" ng-model="action.node">\n        </div>\n        <button class="btn btn-default btn-sm" open-web-element-picker url="action.url" selector="action.node">\n            <i class="fa fa-magic fa-fw"></i>&nbsp; WebPicker\n        </button>\n    </div>\n    <!-- END: CLICK -->\n\n\n    <!-- BEGIN: FILL -->\n    <div ng-if="action.type == actionTypes.FILL">\n        <p class="text-muted">\n            Fill an element with content (eg. input or contenteditable element)\n        </p>\n\n        <div class="form-group">\n            <label class="control-label">CSS selector</label>\n            <input class="form-control" type="text" placeholder="CSS selector" ng-model="action.node">\n        </div>\n        <div class="form-group">\n            <label class="control-label">The value to fill the element with</label>\n            <input class="form-control" type="text" placeholder="value" ng-model="action.generator">\n        </div>\n        <button class="btn btn-default btn-sm" open-web-element-picker url="action.url" selector="action.node">\n            <i class="fa fa-magic fa-fw"></i>&nbsp; WebPicker\n        </button>\n    </div>\n    <!-- END: FILL -->\n\n\n    <!-- BEGIN: GO_TO -->\n    <div ng-if="action.type == actionTypes.GO_TO">\n        <p class="text-muted">\n            Go to a url that is <strong>relative</strong> to your projects\' base url\n        </p>\n\n        <div class="form-group">\n            <label class="control-label">Url</label>\n            <input class="form-control" type="text" placeholder="url" ng-model="action.url">\n        </div>\n    </div>\n    <!-- END: GO_TO -->\n\n\n    <!-- BEGIN: SUBMIT -->\n    <div ng-if="action.type == actionTypes.SUBMIT">\n        <p class="text-muted">\n            Submit a form\n        </p>\n\n        <div class="form-group">\n            <label class="control-label">CSS selector</label>\n            <input class="form-control" type="text" placeholder="CSS selector" ng-model="action.node">\n        </div>\n        <button class="btn btn-default btn-sm" open-web-element-picker url="action.url" selector="action.node">\n            <i class="fa fa-magic fa-fw"></i>&nbsp; WebPicker\n        </button>\n    </div>\n    <!-- END: SUBMIT -->\n\n\n    <!-- BEGIN: WAIT -->\n    <div ng-if="action.type == actionTypes.WAIT">\n        <p class="text-muted">\n            Wait for a specified amount of time before the next action will be executed\n        </p>\n\n        <div class="form-group">\n            <label class="control-label">Time to wait (in ms)</label>\n            <input class="form-control" type="number" placeholder="time in ms" ng-model="action.duration">\n        </div>\n    </div>\n    <!-- END: WAIT -->\n\n    <div ng-if="action.type">\n        <hr>\n        <button class="btn btn-primary btn-sm" type="submit">Create Action</button>\n    </div>\n\n</form>')}]),angular.module("app/views/directives/web-action-edit-form.html",[]).run(["$templateCache",function(a){"use strict";a.put("app/views/directives/web-action-edit-form.html",'<form id="web-action-edit-form" ng-submit="submitForm()">\n\n    <!-- BEGIN: SEARCH_FOR_TEXT -->\n    <div ng-if="action.type == actionTypes.SEARCH_FOR_TEXT">\n        <p class="text-muted">\n            Search on a page for a piece of text or a regular expression\n        </p>\n\n        <div class="form-group">\n            <label class="control-label">Value</label>\n            <input class="form-control" type="text" placeholder="value" ng-model="action.value">\n        </div>\n        <div class="checkbox">\n            <label>\n                <input type="checkbox" ng-model="action.regexp"> Use Regular Expression\n            </label>\n        </div>\n        <button class="btn btn-default btn-sm" open-web-element-picker url="action.url" selector="action.value">\n            <i class="fa fa-magic fa-fw"></i>&nbsp; WebPicker\n        </button>\n    </div>\n    <!-- END: SEARCH_FOR_TEXT -->\n\n\n    <!-- BEGIN: SEARCH_FOR_NODE -->\n    <div ng-if="action.type == actionTypes.SEARCH_FOR_NODE">\n        <p class="text-muted">\n            Search an HTML element in the DOM tree of a page\n        </p>\n\n        <div class="form-group">\n            <label class="control-label">CSS selector</label>\n            <input class="form-control" type="text" placeholder="CSS selector" ng-model="action.value">\n        </div>\n\n        <button class="btn btn-default btn-sm" open-web-element-picker url="action.url" selector="action.value">\n            <i class="fa fa-magic fa-fw"></i>&nbsp; WebPicker\n        </button>\n    </div>\n    <!-- END: SEARCH_FOR_NODE -->\n\n\n    <!-- BEGIN: CLEAR -->\n    <div ng-if="action.type == actionTypes.CLEAR">\n        <p class="text-muted">\n            Clear an element (eg. input or contenteditable element)\n        </p>\n\n        <div class="form-group">\n            <label class="control-label">CSS selector</label>\n            <input class="form-control" type="text" placeholder="CSS selector" ng-model="action.node">\n        </div>\n\n        <button class="btn btn-default btn-sm" open-web-element-picker url="action.url" selector="action.node">\n            <i class="fa fa-magic fa-fw"></i>&nbsp; WebPicker\n        </button>\n    </div>\n    <!-- END: CLEAR -->\n\n\n    <!-- BEGIN: CLICK -->\n    <div ng-if="action.type == actionTypes.CLICK">\n        <p class="text-muted">\n            Click on an element\n        </p>\n\n        <div class="form-group">\n            <label class="control-label">CSS selector</label>\n            <input class="form-control" type="text" placeholder="CSS selector" ng-model="action.node">\n        </div>\n        <button class="btn btn-default btn-sm" open-web-element-picker url="action.url" selector="action.node">\n            <i class="fa fa-magic fa-fw"></i>&nbsp; WebPicker\n        </button>\n    </div>\n    <!-- END: CLICK -->\n\n\n    <!-- BEGIN: FILL -->\n    <div ng-if="action.type == actionTypes.FILL">\n        <p class="text-muted">\n            Fill an element with content (eg. input or contenteditable element)\n        </p>\n\n        <div class="form-group">\n            <label class="control-label">CSS selector</label>\n            <input class="form-control" type="text" placeholder="CSS selector" ng-model="action.node">\n        </div>\n        <div class="form-group">\n            <label class="control-label">The value to fill the element with</label>\n            <input class="form-control" type="text" placeholder="value" ng-model="action.generator">\n        </div>\n        <button class="btn btn-default btn-sm" open-web-element-picker url="action.url" selector="action.node">\n            <i class="fa fa-magic fa-fw"></i>&nbsp; WebPicker\n        </button>\n    </div>\n    <!-- END: FILL -->\n\n\n    <!-- BEGIN: GO_TO -->\n    <div ng-if="action.type == actionTypes.GO_TO">\n        <p class="text-muted">\n            Go to a url that is <strong>relative</strong> to your projects\' base url\n        </p>\n\n        <div class="form-group">\n            <label class="control-label">Url</label>\n            <input class="form-control" type="text" placeholder="url" ng-model="action.url">\n        </div>\n    </div>\n    <!-- END: GO_TO -->\n\n\n    <!-- BEGIN: SUBMIT -->\n    <div ng-if="action.type == actionTypes.SUBMIT">\n        <p class="text-muted">\n            Submit a form\n        </p>\n\n        <div class="form-group">\n            <label class="control-label">CSS selector</label>\n            <input class="form-control" type="text" placeholder="CSS selector" ng-model="action.node">\n        </div>\n        <button class="btn btn-default btn-sm" open-web-element-picker url="action.url" selector="action.node">\n            <i class="fa fa-magic fa-fw"></i>&nbsp; WebPicker\n        </button>\n    </div>\n    <!-- END: SUBMIT -->\n\n\n    <!-- BEGIN: WAIT -->\n    <div ng-if="action.type == actionTypes.WAIT">\n        <p class="text-muted">\n            Wait for a specified amount of time before the next action will be executed\n        </p>\n\n        <div class="form-group">\n            <label class="control-label">Time to wait (in ms)</label>\n            <input class="form-control" type="number" placeholder="time in ms" ng-model="action.duration">\n        </div>\n    </div>\n    <!-- END: WAIT -->\n\n    <hr>\n    <button class="btn btn-primary btn-sm" type="submit">Update Action</button>\n\n</form>')
    ...
    function a(a, b, c) {
        b.otherwise("/home"), a.state("home", {
            ...
            url: "/help",
            templateUrl: c.views.PAGES + "/help.html",
            data: {requiresProject: !1}
        }).state("tools", {
            "abstract": !0,
            ...
            templateUrl: c.views.PAGES + "/tools-hypotheses-view.html",
            data: {requiresProject: !1}
        })
    }
    ...
    "use strict";
    angular.module("weblearner.constants").constant("_", window._).constant("paths", {
        views: {
            BASE: "app/views",
    ...
    "use strict";
    function a(a, b, c, d) {
        a.actionTypes = d, a.selectedActionType, a.symbol = c.symbol, a.action, console.log(a.actionTypes), a.createAction = function (a) {
            b.close(a)
    ...
    angular.module("weblearner.controller").controller("ActionCreateModalController", ["$scope", "$modalInstance", "modalData", "actionTypes", a])
}(), function () {
    "use strict";
    function a(a, b, c, d, e) {
        ...
        a.webActionTypes = d, a.restActionTypes = e, a.symbol = c.symbol, a.action = angular.copy(c.action), a.$on("action.edited", f), a.closeModal = function () {
            b.dismiss()
        }
    }

    angular.module("weblearner.controller").controller("ActionEditModalController", ["$scope", "$modalInstance", "modalData", "WebActionTypes", "RestActionTypes", a])
}(), function () {
    "use strict";
    function a(a, b, c) {
    ...
    angular.module("weblearner.controller").controller("ConfirmDialogController", ["$scope", "$modalInstance", "modalData", a])
}(), function () {
    "use strict";
    function a(a, b, c) {
    ...
    angular.module("weblearner.controller").controller("PromptDialogController", ["$scope", "$modalInstance", "modalData", a])
}(), function () {
    "use strict";
    function a(a, b, c, d, e) {
        var f = c.projectId;
        a.symbol = new d, a.groups = [], a.selectedGroup, e.Resource.getAll(f).then(function (b) {
            a.groups = b
        }), a.createSymbol = function () {
            var c = _.find(a.groups, {name: a.selectedGroup});
            angular.isDefined(c) && (a.symbol.group = c.id), d.Resource.create(f, a.symbol).then(function (a) {
                b.close(a)
            })
        }, a.closeModal = function () {
            b.dismiss()
    ...
    angular.module("weblearner.controller").controller("SymbolCreateModalController", a), a.$inject = ["$scope", "$modalInstance", "modalData", "Symbol", "SymbolGroup"]
}(), function () {
    "use strict";
    function a(a, b, c, d, e) {
        a.symbol = c.symbol, a.updateSymbol = function () {
            e.removeSelection(a.symbol), a.symbol.type = "web", d.Resource.update(a.symbol.project, a.symbol).then(function (a) {
                b.close(a)
            })
        }, a.closeModal = function () {
            b.dismiss()
    ...
    angular.module("weblearner.controller").controller("SymbolEditModalController", a), a.$inject = ["$scope", "$modalInstance", "modalData", "Symbol", "SelectionService"]
}(), function () {
    "use strict";
    function a(a, b, c, d, e) {
        a.projectId = c.projectId, a.group = new d, a.groups = [], a.groupExists = !1, d.Resource.getAll(a.projectId).then(function (b) {
            a.groups = b
        }), a.createGroup = function () {
            var c = e.findIndex(a.groups, {name: a.group.name});
            -1 === c ? (d.Resource.create(a.projectId, a.group).then(function (a) {
                b.close(a)
            }), a.groupExists = !1) : a.groupExists = !0
        }, a.closeModal = function () {
            b.dismiss()
        }
    }

    angular.module("weblearner.controller").controller("SymbolGroupCreateModalController", a), a.$inject = ["$scope", "$modalInstance", "modalData", "SymbolGroup", "_"]
}(), function () {
    "use strict";
    function a(a, b, c, d) {
        a.groupExists = !1, a.group = c.group.copy(), a.groups = [], d.Resource.getAll(a.group.project).then(function (b) {
            a.groups = b
        }), a.updateGroup = function () {
            d.Resource.update(a.group.project, a.group).then(function (a) {
                b.close({status: "updated", group: a})
            })
        }, a.deleteGroup = function () {
            d.Resource["delete"](a.group.project, a.group).then(function () {
                b.close({status: "updated", group: a.group})
            })
        }, a.closeModal = function () {
            b.dismiss()
        }
    ...
    angular.module("weblearner.controller").controller("SymbolGroupEditModalController", a), a.$inject = ["$scope", "$modalInstance", "modalData", "SymbolGroup", "_"]
}(), function () {
    "use strict";
    function a(a, b, c) {
        a.symbols = c.symbols, a.groups = c.groups, a.selectedGroup = null, a.moveSymbols = function () {
            null !== a.selectedGroup
        }, a.selectGroup = function (b) {
            a.selectedGroup = a.selectedGroup.name == b.name ? null : b
        }, a.closeModal = function () {
            b.dismiss()
        }
    }

    angular.module("weblearner.controller").controller("SymbolMoveModalController", a), a.$inject = ["$scope", "$modalInstance", "modalData", "Symbol"]
}(), function () {
    "use strict";
    function a(a, b, c) {
        a.test = c.test, a.ok = function () {
            b.dismiss()
        }
    }

    angular.module("weblearner.controller").controller("TestDetailsController", ["$scope", "$modalInstance", "modalData", a])
}(), function () {
    "use strict";
    function a(a, b, c, d, e, f) {
        a.eqOracles = d, a.learnAlgorithms = e, a.learnConfiguration = c.learnConfiguration, a.$watch("learnConfiguration.eqOracle.type", function (b) {
            a.learnConfiguration.eqOracle = f.create(b)
        }), a.ok = function () {
    ...
    angular.module("weblearner.controller").controller("TestSetupSettingsController", ["$scope", "$modalInstance", "modalData", "EqOraclesEnum", "LearnAlgorithmsEnum", "EqOracleService", a])
}(), function () {
    function a(a, b, c, d) {
        a.project = b.project.get(), a.groups = [], a.allSymbols = [], a.collapseAll = !1, c.Resource.getAll(a.project.id, {embedSymbols: !0}).then(function (b) {
            a.groups = b, a.allSymbols = d.flatten(d.pluck(a.groups, "symbols"))
        }), a.addGroup = function () {
        }, a.deleteGroup = function () {
        }, a.updateGroup = function () {
        }
    ...
    angular.module("weblearner.controller").controller("GroupsController", a), a.$inject = ["$scope", "SessionService", "SymbolGroup", "_"]
}(), function () {
    "use strict";
    function a(a, b, c, d) {
        a.projects = [], d.project.get() && b.go("project"), c.Resource.all().then(function (b) {
            a.projects = b
    ...
    function a(a, b, c, d) {
        function e(b, c) {
            b = b.split(","), _.forEach(b, function (b) {
                d.getComplete(a.project.id, b).then(function (b) {
                    angular.isUndefined(c) ? a.panels.push(b) : a.panels[c] = b
                })
            })
        }

        a.project = c.project.get(), a.finalTestResults = [], a.panels = [], a.layoutSettings = [], d.getAllFinal(a.project.id).then(function (c) {
            return a.finalTestResults = c, b.testNos
        }).then(e), a.fillPanel = function (a, b) {
            e(a.testNo + "", b)
        }
    }

    angular.module("weblearner.controller").controller("LearnResultsCompareController", ["$scope", "$stateParams", "SessionService", "LearnResultResource", a])
}(), function () {
    "use strict";
    function a(a, b, c, d, e) {
        a.project = b.project.get(), a.tests = [], c.getAllFinal(a.project.id).then(function (b) {
            a.tests = b
        }), a.deleteTest = function (b) {
            d.removeSelection(b), e.confirm("Do you want to permanently delete this result?").then(function () {
                c["delete"](a.project.id, b.testNo).then(function () {
                    _.remove(a.tests, {testNo: b.testNo})
                })
            })
        }, a.deleteTests = function () {
            var b, f = d.getSelected(a.tests);
            f.length > 0 && (b = _.pluck(f, "testNo"), e.confirm("Do you want to permanently delete this result?").then(function () {
                c["delete"](a.project.id, b).then(function () {
                    _.forEach(b, function (b) {
                        _.remove(a.tests, {testNo: b})
                    })
                })
            }))
        }
    ...
    angular.module("weblearner.controller").controller("LearnResultsController", ["$scope", "SessionService", "LearnResultResource", "SelectionService", "PromptService", a])
}(), function () {
    "use strict";
    function a(a, b, c, d, e) {
        a.project = b.project.get(), a.tests = [], a.chartModes = {
            SINGLE_COMPLETE_TEST_RESULT: 0,
            MULTIPLE_FINAL_TEST_RESULTS: 1,
            TWO_COMPLETE_TEST_RESULTS: 2
        }, a.chartMode, a.chartDataSets = [], c.getAllFinal(a.project.id).then(function (b) {
            a.tests = b
        }), a.chartFromMultipleFinalTestResults = function () {
            var b = e.getSelected(a.tests);
            b.length > 0 && (a.chartMode = a.chartModes.MULTIPLE_FINAL_TEST_RESULTS, a.chartDataSets = [d.createChartDataFromMultipleTestResults(b)])
        }, a.chartFromSingleCompleteTestResult = function () {
            var b = e.getSelected(a.tests);
            1 == b.length && c.getComplete(a.project.id, b[0].testNo).then(function (b) {
                a.chartMode = a.chartModes.SINGLE_COMPLETE_TEST_RESULT, a.chartDataSets = [d.createChartDataFromSingleCompleteTestResult(b)]
            })
        }, a.chartFromTwoCompleteTestResults = function () {
            var b = e.getSelected(a.tests), f = [];
            2 == b.length && c.getComplete(a.project.id, b[0].testNo).then(function (e) {
                f.push(d.createChartDataFromSingleCompleteTestResult(e)), c.getComplete(a.project.id, b[1].testNo).then(function (b) {
                    f.push(d.createChartDataFromSingleCompleteTestResult(b)), a.chartMode = a.chartModes.TWO_COMPLETE_TEST_RESULTS, a.chartDataSets = f
                })
            })
        }, a.back = function () {
            a.chartDataSets = []
    ...
    angular.module("weblearner.controller").controller("LearnResultsStatisticsController", ["$scope", "SessionService", "LearnResultResource", "TestResultsChartService", "SelectionService", a])
}(), function () {
    "use strict";
    function a(a, b, c, d, e, f, g, h, i) {
        a.project = d.project.get(), a.groups = [], a.allSymbols = [], a.collapseAll = !1, a.resetSymbol, a.learnConfiguration = {
            symbols: [],
            algorithm: g.EXTENSIBLE_LSTAR,
            eqOracle: {type: f.COMPLETE, minDepth: 1, maxDepth: 1},
            maxAmountOfStepsToLearn: 0
        }, h.isActive().then(function (d) {
            d.active ? d.project == a.project.id ? b.go("learn.start") : i.create({
                "class": "danger",
                content: "There is already running a test from another project.",
                dismissButton: !0
            }) : c.Resource.getAll(a.project.id, {embedSymbols: !0}).then(function (b) {
                a.groups = b, a.allSymbols = _.flatten(_.pluck(a.groups, "symbols"))
            })
        }), a.setResetSymbol = function (b) {
            a.resetSymbol = b
        }, a.startLearning = function () {
            var c = e.getSelected(a.allSymbols);
            c.length && a.resetSymbol && (_.forEach(c, function (b) {
                a.learnConfiguration.symbols.push({id: b.id, revision: b.revision})
            }), a.learnConfiguration.resetSymbol = {
                id: a.resetSymbol.id,
                revision: a.resetSymbol.revision
            }, h.start(a.project.id, a.learnConfiguration).then(function () {
                b.go("learn.start")
            }))
    ...
    angular.module("weblearner.controller").controller("LearnSetupController", ["$scope", "$state", "SymbolGroup", "SessionService", "SelectionService", "EqOraclesEnum", "LearnAlgorithmsEnum", "LearnerResource", "ngToast", a])
}(), function () {
    function a(a, b, c, d, e) {
        function f() {
            a.active = !0, h = c(function () {
                e.isActive().then(function (b) {
                    b.active || (e.status().then(function (b) {
                        a.active = !1, a.test = b, a.isEqOracleSample = "sample" == b.configuration.eqOracle.type
                    }), c.cancel(h))
                })
            }, i)
        }

        var g = d.project.get(), h = null, i = 1e4;
        a.test = null, a.active = !1, a.isEqOracleSample = !1, a.counterExample = {
            input: "",
            output: ""
        }, a.layoutSettings, f(), a.$on("$destroy", function () {
            c.cancel(h)
        }), a.updateLearnConfiguration = function (b) {
            a.test.configuration = b
        }, a.resumeLearning = function () {
            var b = angular.copy(a.test.configuration);
            delete b.algorithm, delete b.symbols, e.resume(g.id, a.test.testNo, b).then(function () {
                f()
            })
        }, a.abort = function () {
            a.active && e.stop().then(function (a) {
                console.log(a)
            })
        }
    }

    angular.module("weblearner.controller").controller("LearnStartController", ["$scope", "$stateParams", "$interval", "SessionService", "LearnerResource", a])
}(), function () {
    "use strict";
    function a(a, b) {
    ...
    function a(a, b, c) {
        a.project = new c, a.createProject = function () {
            c.Resource.create(a.project).then(function () {
                b.go("home")
            })
        }
    }

    angular.module("weblearner.controller").controller("ProjectCreateController", a), a.$inject = ["$scope", "$state", "Project"]
}(), function () {
    "use strict";
    function a(a, b, c, d, e) {
        var f;
        a.project = d.project.get(), f = angular.copy(a.project), a.updateProject = function () {
            delete a.project.symbolAmount, c.Resource.update(a.project).then(function (b) {
                d.project.save(b), a.project = b, f = angular.copy(a.project)
            })
        }, a.deleteProject = function () {
            var f = "Do you really want to delete this project with all its symbols and test results? This process can not be undone.";
            e.confirm(f).then(function () {
                c.Resource["delete"](a.project).then(function () {
                    d.project.remove(), b.go("home")
                })
            })
        }, a.resetForm = function () {
            a.project = angular.copy(f)
        }
    }

    angular.module("weblearner.controller").controller("ProjectSettingsController", ["$scope", "$state", "Project", "SessionService", "PromptService", a])
}(), function () {
    "use strict";
    function a(a, b, c, d, e) {
        function f(b) {
        ...
        a.project = d.project.get(), a.symbol, a.symbolCopy, c.Resource.get(a.project.id, b.symbolId).then(f), a.deleteSelectedActions = function () {
            var b = e.getSelected(a.symbol.actions);
            b.length && _.forEach(b, a.deleteAction)
        }, a.deleteAction = function (b) {
            _.remove(a.symbol.actions, {_id: b._id})
        }, a.addAction = function (b) {
            b._id = _.uniqueId(), a.symbol.actions.push(b)
        }, a.updateAction = function (b) {
            var c = _.findIndex(a.symbol.actions, {_id: b._id});
            c > -1 && (a.symbol.actions[c] = b)
        }, a.saveChanges = function () {
            var b = a.symbol.copy();
            e.removeSelection(b.actions), _.forEach(b.actions, function (a) {
                delete a._id
            }), c.Resource.update(a.project.id, b).then(f)
        }, a.revertChanges = function () {
            a.symbol = angular.copy(a.symbolCopy)
        }
    }

    angular.module("weblearner.controller").controller("SymbolsActionsController", a), a.$inject = ["$scope", "$stateParams", "Symbol", "SessionService", "SelectionService", "ngToast"]
}(), function () {
    "use strict";
    function a(a, b, c, d, e) {
        a.project = b.project.get(), a.groups = [], a.allSymbols = [], a.collapseAll = !1, c.Resource.getAll(a.project.id, {embedSymbols: !0}).then(function (b) {
            a.groups = b, a.allSymbols = e.flatten(e.pluck(a.groups, "symbols"))
        }), a.toggleCollapseAllGroups = function () {
            a.collapseAll = !a.collapseAll, e.forEach(a.groups, function (b) {
                b._isCollapsed = a.collapseAll
            })
        }, a.deleteSymbol = function (b) {
            Symbol.Resource["delete"](a.project.id, b.id).then(function (b) {
                e.remove(a.symbols, {id: b.id})
            })
        }, a.moveSelectedSymbolsTo = function (b) {
            var c = d.getSelected(a.allSymbols);
            d.removeSelection(c), e.forEach(c, function (a) {
                a.group = b.id, b.push(a)
            })
        }, a.deleteSelectedSymbols = function () {
            var b, c = d.getSelected(a.symbols);
            c.length && (b = e.pluck(c, "id"), Symbol.Resource.deleteSome(a.project.id, b).then(function (b) {
                e.forEach(b, function (b) {
                    e.remove(a.symbols, {id: b.id})
                })
            }))
        }, a.addSymbol = function (b) {
            console.log(b);
            var c = e.findIndex(a.groups, {id: b.group});
            c > -1 && (a.groups[c].symbols.push(b), a.allSymbols.push(b))
        }, a.addGroup = function (b) {
            a.groups.push(b)
        }, a.updateSymbol = function () {
        }, a.updateGroup = function (b) {
            var c = e.find(a.groups, {id: b.id});
            angular.isDefined(c) && (c.name = b.name)
        }, a.deleteGroup = function (b) {
            e.forEach(b.symbols, function (b) {
                e.remove(a.allSymbols, {id: b.id})
            }), e.remove(a.groups, {id: b.id})
        }
    }

    angular.module("weblearner.controller").controller("SymbolsController", a), a.$inject = ["$scope", "SessionService", "SymbolGroup", "SelectionService", "_"]
}(), function () {
    "use strict";
    function a(a, b, c, d, e) {
        var f = c.project.get();
        a.symbols = {web: [], rest: []}, d.getAll(f.id).then(function (c) {
            a.symbols.web = b("typeOfWeb")(c), a.symbols.rest = b("typeOfRest")(c)
        }), a.getSelectedSymbols = function () {
            var b = a.symbols.web.concat(a.symbols.rest), c = e.getSelected(b);
            return e.removeSelection(c), _.forEach(c, function (a) {
                delete a.id, delete a.revision, delete a.project
            }), c
        }
    }

    angular.module("weblearner.controller").controller("SymbolsExportController", ["$scope", "$filter", "SessionService", "SymbolResource", "SelectionService", a])
}(), function () {
    "use strict";
    function a(a, b, c, d) {
        a.project = d.project.get(), a.revisions = [], a.latestSymbol, c.getRevisions(a.project.id, b.symbolId).then(function (b) {
            a.latestSymbol = b.pop(), a.revisions = b
        }), a.restoreRevision = function (b) {
            a.latestSymbol.name = b.name, a.latestSymbol.abbreviation = b.abbreviation, a.latestSymbol.actions = b.actions, c.update(a.project.id, a.latestSymbol).then(function (b) {
                a.revisions.push(a.latestSymbol), a.latestSymbol = b
            })
        }
    }

    angular.module("weblearner.controller").controller("SymbolsHistoryController", ["$scope", "$stateParams", "SymbolResource", "SessionService", a])
}(), function () {
    "use strict";
    function a(a, b, c, d) {
        var e = b.project.get();
        a.symbols = {web: [], rest: []}, a.fileLoaded = function (b) {
            var c = angular.fromJson(b);
            _.forEach(a.symbols, function (a) {
                a.project = e.id
            }), a.$apply(function () {
                a.symbols.web = _.filter(c, {type: "web"}), a.symbols.rest = _.filter(c, {type: "rest"})
            })
        }, a.uploadSymbols = function () {
            var b = d.getSelected(a.symbols.web), f = d.getSelected(a.symbols.rest), g = b.concat(f);
            d.removeSelection(g), c.create(e.id, g)
        }
    }

    angular.module("weblearner.controller").controller("SymbolsImportController", ["$scope", "SessionService", "SymbolResource", "SelectionService", a])
}(), function () {
    "use strict";
    function a(a, b, c, d, e) {
        a.project = c.project.get(), a.symbols = [], a.type = b, d.getAll(a.project.id, {
            type: b,
            deleted: !0
        }).then(function (b) {
            a.symbols = b
        }), a.recover = function (b) {
            d.recover(a.project.id, b.id).then(function () {
                _.remove(a.symbols, {id: b.id})
            })
        }, a.recoverSelected = function () {
            var b = e.getSelected(a.symbols);
            _.forEach(b, a.recover)
        }
    }

    angular.module("weblearner.controller").controller("SymbolsTrashController", ["$scope", "type", "SessionService", "SymbolResource", "SelectionService", a])
}(), function () {
    "use strict";
    function a(a) {
        function b(a) {
            a.inputs = ["w1", "w2", "w3"], a.counterExample = [{input: "w1", output: "output1"}, {
                input: "w2",
                output: "output2"
            }, {input: "w3", output: "output3"}], a.add = function () {
                a.counterExample.push({input: null, output: null})
            }, a.remove = function (b) {
                a.counterExample.splice(b, 1)
            }, a.onDropInput = function (b, c, d) {
                a.counterExample[d].input = b["json/custom-object"]
            }, a.onDropOutput = function (b, c, d) {
                a.counterExample[d].output = b["json/custom-object"]
            }
        }
        ...
        var c = {
            scope: {},
            controller: ["$scope", b],
            templateUrl: a.views.DIRECTIVES + "/counter-example-builder.html"
        };
        return c
    }

    angular.module("weblearner.directives").directive("counterExampleBuilder", a), a.$inject = ["paths"]
}(), function () {
    "use strict";
    function a(a) {
        function b(b, c) {
            function d() {
                angular.isDefined(b.data) && a.prompt("Enter a name for the symbols file.", {
                    regexp: /^[a-zA-Z0-9\.\-,_]+$/,
            ...
            function e(a) {
                var c, d = "data:text/json;charset=utf-8,";
                if (angular.isDefined(b.data)) {
                    if (angular.isObject(b.data) || angular.isArray(b.data))d += encodeURIComponent(angular.toJson(b.data)); else {
                        if (!angular.isFunction(b.data))return;
                        d += encodeURIComponent(angular.toJson(b.data()))
                    }
                    c = document.createElement("a"), c.style.display = "none", c.setAttribute("href", d), c.setAttribute("target", "_blank"), c.setAttribute("download", a + ".json"), document.body.appendChild(c), c.click(), document.body.removeChild(c)
                }
            }
        ...
        var c = {restrict: "A", scope: {data: "="}, link: b};
        return c
    }

    angular.module("weblearner.directives").directive("downloadAsJson", ["PromptService", a])
}(), function () {
    "use strict";
    function a(a) {
        function b(b, c, d) {
            function e() {
                a.prompt("Enter a name for the chart image file.", {
                    regexp: /^[a-zA-Z0-9\.\-,_]+$/,
                    errorMsg: 'The name may not be empty and only consist of letters, numbers and the symbols ",._-".'
                }).then(f)
            }
            ...
            function f(a) {
                if (d.downloadCanvasAsImage) {
                    var b, c = document.getElementById(d.downloadCanvasAsImage);
                    if (null != c) {
                        var e = c.toDataURL("image/png", 1);
                        b = document.createElement("a"), b.style.display = "none", b.setAttribute("href", e), b.setAttribute("target", "_blank"), b.setAttribute("download", a + ".png"), document.body.appendChild(b), b.click(), document.body.removeChild(b)
                    }
                }
            }
    ...
    angular.module("weblearner.directives").directive("downloadCanvasAsImage", ["PromptService", a])
}(), function () {
    "use strict";
    function a(a) {
        function b(b, c, d) {
            function e() {
                a.prompt("Enter a name for the svg file.", {
                    regexp: /^[a-zA-Z0-9\.\-,_]+$/,
                    errorMsg: 'The name may not be empty and only consist of letters, numbers and the symbols ",._-".'
                }).then(f)
            }
            ...
            function f(a) {
                var b, c = d.downloadHypothesisAsSvg, e = document.querySelector(c);
                if ("SVG" == e.nodeName || (e = e.getElementsByTagName("svg")[0], null != e)) {
                    e.setAttribute("version", "1.1"), e.setAttribute("xmlns", "http://www.w3.org/2000/svg");
                    var f = (new XMLSerializer).serializeToString(e);
                    b = document.createElement("a"), b.style.display = "none", b.setAttribute("href", "data:image/svg+xml," + f), b.setAttribute("target", "_blank"), b.setAttribute("download", a + ".svg"), document.body.appendChild(b), b.click(), document.body.removeChild(b)
                }
            }
    ...
    angular.module("weblearner.directives").directive("downloadHypothesisAsSvg", ["PromptService", a])
}(), function () {
    function a(a) {
        function b(b, c) {
            function d() {
                angular.isDefined(b.testResults) && a.prompt("Enter a name for the csv file.", {
                    regexp: /^[a-zA-Z0-9\.\-,_]+$/,
                    errorMsg: 'The name may not be empty and only consist of letters, numbers and the symbols ",._-".'
                }).then(e)
            }
            ...
            function e(a) {
                var c, d, e = "data:text/csv;charset=utf-8,";
                if (angular.isDefined(b.testResults)) {
                    if (!angular.isArray(b.testResults))return;
                    d = b.testResults, e += f(d), c = document.createElement("a"), c.style.display = "none", c.setAttribute("href", e), c.setAttribute("target", "_blank"), c.setAttribute("download", a + ".csv"), document.body.appendChild(c), c.click(), document.body.removeChild(c)
                }
            }

            function f(a) {
                var b = '"Type";"Project";"TestNo";"StepNo";"Algorithm";"EqOracle";"Sybols";"Resets";"Duration (ms)"%0A';
                return _.forEach(a, function (a) {
                    b += '"' + a.type + '";', b += '"' + a.project + '";', b += '"' + a.testNo + '";', b += '"' + a.stepNo + '";', b += '"' + a.configuration.algorithm + '";', b += '"' + a.configuration.eqOracle.type + '";', b += '"' + a.sigma.length + '";', b += '"' + a.amountOfResets + '";', b += '"' + a.duration + '"%0A'
                }), b
            }
        ...
        var c = {restrict: "A", scope: {testResults: "="}, link: b};
        return c
    }

    angular.module("weblearner.directives").directive("downloadTestResultsAsCsv", ["PromptService", a])
}(), function () {
    "use strict";
    function a() {
        function a(a, b, c, d) {
        ...
        var b = {restrict: "A", require: "dropdown", link: a};
        return b
    }
    ...
    function a() {
        function a(a, b) {
            ...
            d.onload = function (b) {
                ...
                b[0].style.outline = "4px solid rgba(0,0,0,0.2)"
            }).on("dragleave", function () {
                b[0].style.outline = "0"
            }), b.on("drop", function (a) {
                a.preventDefault(), a.stopPropagation(), c(a.dataTransfer.files), b[0].style.outline = "0"
            })
        }
        ...
        function d(c, d) {
            ...
            function i() {
                _.forEach(c.test.hypothesis.nodes, function (a, b) {
                    p.setNode("" + b, {shape: "circle", label: a.toString(), width: 25})
            ...
            function j() {
                ...
                _.forEach(c.test.hypothesis.nodes, function (a, b) {
                    ...
                    _.forEach(a, function (a, c) {
                        p.setEdge(b, c, {label: a.join("\n"), labeloffset: 5, lineInterpolate: "basis"}, b + "" + c)
                    })
                }), dagreD3.dagre.layout(p, {})
            }
    ...
    angular.module("weblearner.directives").directive("hypothesis", ["$window", "paths", d])
}(), function () {
    "use strict";
    function a() {
        function a(a) {
        ...
        var b = '<div style="position: absolute; top: 50px; bottom: 0; width: 100%;">   <div ng-click="addPanel()" style="position: absolute; right: 0; top: 0; bottom: 0; width: 40px; background: #f2f2f2; border-left: 1px solid #e7e7e7"></div>   <div style="position: absolute; left: 0; top: 0; bottom: 0; right: 40px; background: #fff" ng-transclude></div></div>', c = {
            template: b,
            transclude: !0,
    ...
    function c() {
        function a(a, b, c, d) {
            function e() {
                var a = parseInt(c.panelCloseButton);
                d.closePanelAt(a)
            }
        ...
        var b = {require: "^panelManager", link: a};
        return b
    }
    ...
    function d(a) {
        function b(a, b, c, d) {
            function e() {
                a.index = parseInt(a.panelIndex)
            }

            a.index, a.pointer = a.result.length - 1, a.panels = d.getPanels(), a.$watch("panels.length", e), a.firstStep = function () {
                a.pointer = 0
            }, a.previousStep = function () {
                a.pointer - 1 < 0 ? a.lastStep() : a.pointer--
            }, a.nextStep = function () {
                a.pointer + 1 > a.result.length - 1 ? a.firstStep() : a.pointer++
            }, a.lastStep = function () {
                a.pointer = a.result.length - 1
            }, a.getCurrentStep = function () {
                return a.result[a.pointer]
            }
        }

        var c = {
            require: "^panelManager",
            scope: {result: "=", panelIndex: "@"},
            templateUrl: a.views.DIRECTIVES + "/hypothesis-panel.html",
            link: b
        };
        return c
    }

    angular.module("weblearner.directives").directive("panelManager", a), angular.module("weblearner.directives").directive("panel", b), angular.module("weblearner.directives").directive("panelCloseButton", c), angular.module("weblearner.directives").directive("hypothesisSlideshowPanel", d), d.$inject = ["paths"]
}(), function () {
    "use strict";
    function a(a, b) {
        function c(b, c) {
    ...
    function a(a, b, c) {
        function d(d, e) {
            function f() {
                var e = a.open({
                    templateUrl: c.views.MODALS + "/action-create-modal.html",
                    controller: "ActionCreateModalController",
                    resolve: {
                        modalData: function () {
                            return {symbol: angular.copy(d.symbol)}
                        }
                    }
                });
                e.result.then(function (a) {
                    d.onCreated()(a), b.create({"class": "success", content: "Action created"})
                })
            }
        ...
        var e = {restrict: "EA", scope: {symbol: "=", onCreated: "&"}, link: d};
        return e
    }

    angular.module("weblearner.directives").directive("openActionCreateModal", ["$modal", "ngToast", "paths", a])
}(), function () {
    "use strict";
    function a(a, b, c) {
        function d(d, e) {
            function f() {
                if (!angular.isUndefined(d.action)) {
                    var e = a.open({
                        templateUrl: c.views.MODALS + "/action-edit-modal.html",
                        controller: "ActionEditModalController",
                        resolve: {
                            modalData: function () {
                                return {symbol: angular.copy(d.symbol), action: angular.copy(d.action)}
                            }
                        }
                    });
                    e.result.then(function (a) {
                        b.create({"class": "success", content: "Action updated"}), d.onUpdated()(a)
                    })
                }
            }
        ...
        var e = {restrict: "EA", scope: {symbol: "=", action: "=", onUpdated: "&"}, link: d};
        return e
    }

    angular.module("weblearner.directives").directive("openActionEditModal", ["$modal", "ngToast", "paths", a])
}(), function () {
    function a(a) {
        function b(b, c) {
            c.on("click", function () {
                a.open({
                    inputs: angular.copy(b.inputs),
                    outputs: angular.copy(b.outputs),
                    counterExample: angular.copy(b.counterExample)
                })
            })
        }

        var c = {scope: {inputs: "=", outputs: "=", counterExample: "="}, link: b};
        return c
    }

    angular.module("weblearner.directives").directive("openCounterExampleBuilder", a), a.$inject = ["CounterExampleBuilderService"]
}(), function () {
    "use strict";
    function a(a) {
        function b(b, c) {
            function d() {
                var c = a.open({
                    ...
                    resolve: {
                        modalData: function () {
                            return {layoutSettings: b.layoutSettings}
                        }
                    }
                });
        ...
        var c = {scope: {layoutSettings: "="}, link: b};
        return c
    }

    angular.module("weblearner.directives").directive("openHypothesisLayoutSettingsModal", ["$modal", "paths", a])
}(), function () {
    function a(a, b) {
        function c(c, d) {
            function e() {
                angular.isDefined(c.test) && a.open({
                    templateUrl: b.views.MODALS + "/modal-test-details.html",
                    controller: "TestDetailsController",
                    resolve: {
                        modalData: function () {
                            return {test: angular.copy(c.test)}
                        }
                    }
                })
            }
        ...
        var d = {scope: {test: "="}, link: c};
        return d
    }

    angular.module("weblearner.directives").directive("openTestDetailsModal", ["$modal", "paths", a])
}(), function () {
    "use strict";
    function a(a, b) {
        function c(c, d) {
            function e() {
                var d = a.open({
                    templateUrl: b.views.MODALS + "/modal-test-setup-settings.html",
                    controller: "TestSetupSettingsController",
                    resolve: {
                        modalData: function () {
                            return {learnConfiguration: angular.copy(c.learnConfiguration)}
                        }
                    }
                });
    ...
    angular.module("weblearner.directives").directive("openTestSetupSettingsModal", ["$modal", "paths", a])
}(), function () {
    "use strict";
    function a(a) {
        function b(b, c) {
            function d(a, c) {
                b.url = c.url, b.selector = c.selector
            }

            c.on("click", a.open), b.$on("webElementPicker.ok", d)
        }

        var c = {scope: {url: "=", selector: "="}, link: b};
        return c
    }

    angular.module("weblearner.directives").directive("openWebElementPicker", ["WebElementPickerService", a])
}(), function () {
    "use strict";
    function a(a) {
        function b(b, c) {
            function d() {
                this.checked ? a.selectAll(b.items) : a.deselectAll(b.items), b.$apply()
            }

            c.on("change", d)
        }

        var c = {scope: {items: "="}, link: b};
        return c
    }
    ...
    function b() {
        ...
        var b = {
            ...
            controller: ["$scope", "SelectionService", a]
        };
        return b
    }
    ...
    function c() {
        function a(a, b, c, d) {
            a.item = d.getItems()[a.$index]
        }

        var b = {
            require: "^selectableList",
            transclude: !0,
            template: ' <div class="selectable-list-item" ng-class="item._selected ? \'active\' : \'\'">               <div class="selectable-list-control">                   <input type="checkbox" ng-model="item._selected">               </div>               <div class="selectable-list-content" ng-transclude></div>           </div>',
            link: a
        };
        return b
    }

    angular.module("weblearner.directives").directive("selectAllItemsCheckbox", ["SelectionService", a]), angular.module("weblearner.directives").directive("selectableList", b), angular.module("weblearner.directives").directive("selectableListItem", c)
}(), function () {
    "use strict";
    function a() {
        function a(a, b, c) {
    ...
    function b(a) {
        function b(a) {
            a.$watch("counterExamples.length", function (a) {
                console.log(a)
        ...
        var c = {
            templateUrl: a.views.WIDGETS + "/widget-counter-examples.html",
    ...
    function c(a) {
        function b(a, b, c) {
            a.eqOracles = b, a.$watch("configuration.eqOracle.type", function (b) {
                a.configuration.eqOracle = c.create(b)
            })
        }

        var c = {
            templateUrl: a.views.WIDGETS + "/widget-test-resume-settings.html",
            scope: {configuration: "="},
            controller: ["$scope", "EqOraclesEnum", "EqOracleService", b]
        };
        return c
    }
    ...
    function a(a, b) {
        function c(c, d) {
            function e() {
                ...
                d.result.then(function (a) {
                    "updated" === a.status ? c.onUpdated()(a.group) : "deleted" === a.status && c.onDeleted()(a.group)
                })
            }
    ...
    function a() {
        function a(a, b, c) {
            var d, e, f = b.find("canvas")[0].getContext("2d");
            a.chartProperties = c.chartProperties, a.visibleChartProperty = a.chartProperties.AMOUNT_OF_SYMBOLS, this.createBarChart = function (a) {
                d = new Chart(f).Bar(a, {responsive: !0})
            }, this.createLineChart = function (a) {
                d = new Chart(f).Line(a, {responsive: !0})
            }, this.getChartData = function () {
                return a.chartData
            }, this.setUpdate = function (a) {
                e = a
            }, a.showDuration = function () {
                e(d, a.chartProperties.DURATION), a.visibleChartProperty = a.chartProperties.DURATION
            }, a.showResets = function () {
                e(d, a.chartProperties.AMOUNT_OF_RESETS), a.visibleChartProperty = a.chartProperties.AMOUNT_OF_RESETS
            }, a.showSymbols = function () {
                e(d, a.chartProperties.AMOUNT_OF_SYMBOLS), a.visibleChartProperty = a.chartProperties.AMOUNT_OF_SYMBOLS
            }
        }

        var b = '<div>   <canvas id="test-results-chart" width="800" height="400"></canvas>   <hr>   <div class="text-center">       <button class="btn btn-default btn-sm" ng-class="visibleChartProperty == chartProperties.DURATION ? \'active\' : \'\'" ng-click="showDuration()">Duration</button>       <button class="btn btn-default btn-sm" ng-class="visibleChartProperty == chartProperties.AMOUNT_OF_RESETS ? \'active\' : \'\'" ng-click="showResets()">#Resets</button>       <button class="btn btn-default btn-sm" ng-class="visibleChartProperty == chartProperties.AMOUNT_OF_SYMBOLS ? \'active\' : \'\'" ng-click="showSymbols()">#Symbols</button>   </div></div>', c = {
            scope: {chartData: "="},
            controller: ["$scope", "$element", "TestResultsChartService", a],
            template: b
        };
        return c
    }

    angular.module("weblearner.directives").directive("testResultsChart", a)
}(),function () {
    "use strict";
    function a() {
        function a(a, b, c, d) {
            function e(a) {
                angular.isDefined(a) && (a = a[0], g = angular.copy(a.datasets), a.datasets = [g[0]], d.createBarChart(a), d.setUpdate(f))
            }

            function f(a, b) {
                _.forEach(g[b].data, function (b, c) {
                    a.datasets[0].bars[c].value = b
                }), a.update()
            }

            var g;
            a.chartData = d.getChartData(), a.$watch("chartData", e)
        }

        var b = {require: "testResultsChart", link: a};
        return b
    }

    angular.module("weblearner.directives").directive("testResultsChartMultipleFinal", a)
}(),function () {
    "use strict";
    function a() {
        function a(a, b, c, d) {
            function e(a) {
                angular.isDefined(a) && (a = a[0], h = angular.copy(a.datasets), a.datasets = [h[0]], 1 == a.datasets[0].data.length ? (d.createBarChart(a), d.setUpdate(f)) : (d.createLineChart(a), d.setUpdate(g)))
            }

            function f(a, b) {
                _.forEach(h[b].data, function (b, c) {
                    a.datasets[0].bars[c].value = b
                }), a.update()
            }
    ...
    angular.module("weblearner.directives").directive("testResultsChartSingleComplete", a)
}(),function () {
    "use strict";
    function a() {
        function a(a, b, c, d) {
            function e(a) {
                angular.isDefined(a) && (h = angular.copy(a[0].datasets), i = angular.copy(a[1].datasets), a[1].labels.length > a[0].labels.length && (a[0].labels = a[1].labels), a = a[0], a.datasets = [h[0], i[0]], 1 == a.labels.length ? (d.createBarChart(a), d.setUpdate(f)) : a.labels.length > 1 && (d.createLineChart(a), d.setUpdate(g)))
            }

            function f(a, b) {
                _.forEach(h[b].data, function (b, c) {
                    a.datasets[0].bars[c].value = b
                }), _.forEach(i[b].data, function (b, c) {
                    a.datasets[1].bars[c].value = b
                }), a.update()
            }
    ...
    angular.module("weblearner.directives").directive("testResultsChartTwoComplete", a)
}(),function () {
    "use strict";
    function a() {
        var a = '<div class="view-heading">   <div class="container">       <h2 class="view-heading-title" ng-bind="::title"></h2>       <p class="view-heading-sub-title" ng-bind="::subTitle"></p>   </div></div>';
        return {scope: {title: "@", subTitle: "@"}, template: a}
    }

    angular.module("weblearner.directives").directive("viewHeading", a)
}(),function () {
    "use strict";
    function a(a, b, c) {
        function d(a, b) {
            function c() {
                angular.element(h.contents()[0].body.querySelectorAll("a")).on("click", function () {
                })
            }
            ...
            function e(b) {
                return i == b.target ? !1 : (null != i && (i.style.outline = "0px"), i = b.target, i.style.outline = "5px solid red", a.selector = d(i), void a.$apply())
            }

            function f(a) {
                angular.isDefined(a) && (a.preventDefault(), a.stopPropagation()), i.style.outline = "0px", i = null, angular.element(h.contents()[0].body).off("mousemove", e), angular.element(h.contents()[0].body).off("click", f), angular.element(document.body).off("keyup", g)
            }
            ...
            var h = b.find("iframe"), i = null;
            a.url = "", a.selector = null, h.on("load", c), a.loadUrl = function () {
                "" == a.url ? h[0].setAttribute("src", a.proxyUrl) : h[0].setAttribute("src", a.proxyUrl + "/" + a.url)
            }, a.enableSelection = function () {
                var a = angular.element(h.contents()[0].body);
                a.on("mousemove", e), a.one("click", f), angular.element(document.body).on("keyup", g)
            }
        }

        function e(c, d, e) {
            c.show = !1, c.project = d.project.get(), c.proxyUrl = null, null != c.project && (c.proxyUrl = a.location.origin + e.api.PROXY_URL + c.project.baseUrl), c.$on("webElementPicker.open", function () {
                c.show = !0
            }), c.$on("project.opened", function () {
                c.project = d.project.get(), c.proxyUrl = a.location.origin + "/rest/proxy?url=" + c.project.baseUrl
            }), c.close = function () {
                c.show = !1, b.close()
            }, c.ok = function () {
                b.ok({url: "", selector: c.selector}), c.show = !1
            }
        }

        var f = {
            scope: {},
            templateUrl: c.views.DIRECTIVES + "/web-element-picker.html",
            link: d,
            controller: ["$scope", "SessionService", "paths", e]
        };
        return f
    }

    angular.module("weblearner.directives").directive("webElementPicker", ["$window", "WebElementPickerService", "paths", a])
}(),function () {
    function a() {
    }

    angular.module("weblearner.models").factory("Action", a)
}(),function () {
    function a(a) {
        function b(b, c) {
            this.type = a.RANDOM, this.minLength = b || 1, this.maxLength = c || 1
        }
        ...
        var f = {Random: b, Complete: c, Sample: d, build: e};
        return f
    }
    ...
    function a(a, b) {
        function c() {
            this.symbols = [], this.maxAmountOfStepsToLearn = 0, this.eqOracle = new b.Complete, this.algorithm = a.EXTENSIBLE_LSTAR
        }

        return c.build = function (a) {
            var b = new c;
            return b.symbols = a.symbols, b.maxAmountOfStepsToLearn = a.maxAmountOfStepsToLearn, b.algorithm = a.algorithm, b.eqOracle = a.eqOracle, b
        }, c
    }
    ...
    function a(a) {
        ...
        return b.prototype.copy = function () {
            return b.build(angular.copy(this))
        }, b.build = function (a) {
            var c = new b(a.name, a.abbreviation);
            return c.actions = a.actions, c.id = a.id, c.revision = a.revision, c.project = a.project, c.hidden = a.hidden, c.group = a.group, c
        }, b.buildSome = function (a) {
            for (var c = [], d = 0; d < a.length; d++)c.push(b.build(a[d]));
            return c
        }, b.Resource = new a, b.Resource.build = b.build, b.Resource.buildSome = b.buildSome, b
    ...
    angular.module("weblearner.models").factory("Symbol", a), a.$inject = ["SymbolResource"]
}(),function () {
    function a(a, b) {
        function c(a) {
    ...
    angular.module("weblearner.models").factory("SymbolGroup", a), a.$inject = ["SymbolGroupResource", "Symbol"]
}(),function () {
    "use strict";
    function a(a, b, c, d) {
        function e(b) {
            return a.get(c.api.URL + "/projects/" + b + "/results").then(d.success)["catch"](d.fail)
        }

        function f(b, e) {
            return a.get(c.api.URL + "/projects/" + b + "/results/" + e).then(d.success)["catch"](d.fail)
        }

        function g(b, e) {
            return a.get(c.api.URL + "/projects/" + b + "/results/" + e + "/complete").then(d.success)["catch"](d.fail)
        }

        function h(b, e) {
            function f(a) {
                var b = "The results were deleted";
                return d.successWithToast(a, b)
            }

            return angular.isArray(e) && (e = e.join()), a["delete"](c.api.URL + "/projects/" + b + "/results/" + e, {}).then(f)["catch"](d.fail)
        }

        var i = {getAllFinal: e, getFinal: f, getComplete: g, "delete": h};
        return i
    }

    angular.module("weblearner.resources").factory("LearnResultResource", ["$http", "$q", "paths", "ResourceResponseService", a])
}(),function () {
    "use strict";
    function a(a, b, c, d) {
        function e(b, e) {
            return a.post(c.api.URL + "/learner/start/" + b, e).then(d.success)["catch"](d.fail)
        }

        function f() {
            return a.get(c.api.URL + "/learner/stop/").then(d.success)["catch"](d.fail)
        }

        function g(b, e, f) {
            return a.post(c.api.URL + "/learner/resume/" + b + "/" + e, f).then(d.success)["catch"](d.fail)
        }

        function h() {
            return a.get(c.api.URL + "/learner/status/").then(d.success)["catch"](d.fail)
        }

        function i() {
            return a.get(c.api.URL + "/learner/active").then(d.success)["catch"](d.fail)
        }

        var j = {start: e, stop: f, resume: g, status: h, isActive: i};
        return j
    }

    angular.module("weblearner.resources").factory("LearnerResource", ["$http", "$q", "paths", "ResourceResponseService", a])
}(),function () {
    "use strict";
    function a(a, b, c) {
        function d() {
        ...
        return d.prototype.all = function () {
            ...
            var e = this;
            return a.get(b.api.URL + "/projects/" + d).then(function (a) {
                return e.build(a.data)
            })["catch"](c.fail)
        }, d.prototype.create = function (d) {
            var e = this;
            return a.post(b.api.URL + "/projects", d).then(function (a) {
                return e.build(a.data)
            })["catch"](c.fail)
        }, d.prototype.update = function (d) {
            var e = this;
            return a.put(b.api.URL + "/projects/" + d.id, d).then(function (a) {
                return e.build(a.data)
            })["catch"](c.fail)
        }, d.prototype["delete"] = function (d) {
            var e = this;
            return a["delete"](b.api.URL + "/projects/" + d.id).then(function (a) {
                return e.build(a.data)
            })["catch"](c.fail)
    ...
    angular.module("weblearner.resources").factory("ProjectResource", a), a.$inject = ["$http", "paths", "ResourceResponseService"]
}(),function () {
    function a(a, b) {
        function c() {
        }
    ...
    function a(a, b, c) {
        ...
        return d.prototype.get = function (d, e) {
            function f(a) {
                return g.build(a.data)
            }

            var g = this;
            return a.get(b.api.URL + "/projects/" + d + "/symbols/" + e).then(f)["catch"](c.fail)
        }, d.prototype.getAll = function (d, e) {
            function f(a) {
                return h.buildSome(a.data)
            }

            var g, h = this;
            return e && e.deleted && e.deleted === !0 && (g = "?visbility=hidden"), a.get(b.api.URL + "/projects/" + d + "/symbols" + (g ? g : "")).then(f)["catch"](c.fail)
        }, d.prototype.getRevisions = function (d, e) {
            function f(a) {
                return g.buildSome(a.data)
            }

            var g = this;
            return a.get(b.api.URL + "/projects/" + d + "/symbols/" + e + "/complete").then(f)["catch"](c.fail)
            ...
            var g = this;
            return a.post(b.api.URL + "/projects/" + d + "/symbols", e).then(f)["catch"](c.fail)
        }, d.prototype.createSome = function (d, e) {
            function f(a) {
                return g.buildSome(a.data)
            }
            ...
            var g = this;
            return a.put(b.api.URL + "/projects/" + d + "/symbols/" + e.id, e).then(f)["catch"](c.fail)
        }, d.prototype["delete"] = function (d, e) {
            function f(a) {
                return g.build(a.data)
            }

            var g = this;
            return a.post(b.api.URL + "/projects/" + d + "/symbols/" + e + "/hide", {}).then(f)["catch"](c.fail)
            ...
            var g = this;
            return e = e.join(","), a.post(b.api.URL + "/projects/" + d + "/symbols/" + symbolsIds + "/hide", {}).then(f)["catch"](c.fail)
        }, d.prototype.recover = function (d, e) {
            function f(a) {
                return g.build(a.data)
            }

            var g = this;
            return a.post(b.api.URL + "/projects/" + d + "/symbols/" + e + "/show", {}).then(f)["catch"](c.fail)
        }, d.prototype.build = function (a) {
            return a
        }, d.prototype.buildSome = function (a) {
            return a
    ...
    angular.module("weblearner.resources").factory("SymbolResource", a), a.$inject = ["$http", "paths", "ResourceResponseService"]
}(),function () {
    function a(a) {
        function b() {
            a.$broadcast("counterExampleBuilder.open")
        }

        function c() {
            a.$broadcast("counterExampleBuilder.close")
        }

        function d() {
            a.$broadcast("counterExampleBuilder.ok")
        }

        var e = {open: b, close: c, ok: d};
        return e
    }

    angular.module("weblearner.services").service("CounterExampleBuilderService", a), a.$inject = ["$rootScope"]
}(),function () {
    "use strict";
    function a(a) {
        function b(b) {
        ...
        var c = {type: a.COMPLETE, minDepth: 1, maxDepth: 1}, d = {
            type: a.RANDOM,
            minLength: 1,
            maxLength: 1,
            maxNoOfTests: 1
        }, e = {type: a.SAMPLE, counterExamples: []}, f = {create: b};
        return f
    }

    angular.module("weblearner.services").factory("EqOracleService", ["EqOraclesEnum", a])
}(),function () {
    "use strict";
    function a(a) {
        function b() {
            a.$broadcast("loadScreen.show")
        }

        function c() {
            a.$broadcast("loadScreen.hide")
        }
    ...
    angular.module("weblearner.services").factory("LoadScreenService", ["$rootScope", a])
}(),function () {
    "use strict";
    function a(a, b) {
        function c(c, d) {
            var e = a.open({
                templateUrl: b.views.MODALS + "/modal-prompt-dialog.html",
        ...
        function d(c) {
            var d = a.open({
                templateUrl: b.views.MODALS + "/modal-confirm-dialog.html",
    ...
    function a(a, b) {
        ...
        function d(a, c) {
            return b.create({"class": "success", content: c}), a.data
        }

        function e(a) {
            return console.error(a.data), f(a, a.data)
        }

        function f(c, d) {
            return console.error(c.data), b.create({"class": "danger", content: d, dismissButton: !0}), a.reject()
        }

        function g(b) {
            return console.error(b.data), a.reject()
        }

        var h = {success: c, successWithToast: d, fail: e, failWithoutToast: g, failWithToast: f};
        return h
    }

    angular.module("weblearner.services").factory("ResourceResponseService", ["$q", "ngToast", a])
}(),function () {
    "use strict";
    function a() {
        function a(a) {
        ...
        function f(a) {
            angular.isArray(a) || (a = [a]), _.forEach(a, function (a) {
                delete a[i]
            })
        }
    ...
    angular.module("weblearner.services").factory("SelectionService", a)
}(),function () {
    "use strict";
    function a(a, b) {
        function c() {
        ...
        var f = {project: {get: c, save: d, remove: e}};
        return f
    }
    ...
    function a() {
        ...
        function b(b) {
            var c = {labels: [], datasets: [a("Symbols", []), a("Duration", []), a("Resets", [])]};
            return _.forEach(b, function (a) {
                c.labels.push("Test " + a.testNo), c.datasets[d.AMOUNT_OF_SYMBOLS].data.push(a.sigma.length), c.datasets[d.DURATION].data.push(a.duration), c.datasets[d.AMOUNT_OF_RESETS].data.push(a.amountOfResets)
            }), c
        }
        ...
        function c(b) {
            var c = {labels: [], datasets: [a("Symbols", []), a("Duration", []), a("Resets", [])]};
            return _.forEach(b, function (a) {
                c.labels.push("Step " + a.stepNo), c.datasets[d.AMOUNT_OF_SYMBOLS].data.push(a.sigma.length), c.datasets[d.DURATION].data.push(a.duration), c.datasets[d.AMOUNT_OF_RESETS].data.push(a.amountOfResets)
            }), c
        }
        ...
        var d = {
            ...
            createChartDataFromMultipleTestResults: b,
            createChartDataFromSingleCompleteTestResult: c,
            chartProperties: d
        };
        return e
    }

    angular.module("weblearner.services").service("TestResultsChartService", a)
}(),function () {
    "use strict";
    function a(a) {
        function b() {
            a.$broadcast("webElementPicker.open")
        }

        function c() {
            a.$broadcast("webElementPicker.close")
        }

        function d(b) {
            a.$broadcast("webElementPicker.ok", b)
        }
    ...
    angular.module("weblearner.services").factory("WebElementPickerService", ["$rootScope", a])
}(),function () {
    "use strict";
    function a() {
        return function (a) {
    ...
    angular.module("weblearner.filters").filter("first", a)
}(),function () {
    "use strict";
    function a(a) {
        return function (b) {
    ...
    angular.module("weblearner.filters").filter("niceEqOracleName", ["EqOraclesEnum", a]), angular.module("weblearner.filters").filter("niceLearnAlgorithmName", ["LearnAlgorithmsEnum", b])
}(),function () {
    "use strict";
    function a(a) {
        return function (b) {
    ...
    angular.module("weblearner.filters").filter("selected", ["SelectionService", a])
}(),function () {
    "use strict";
    function a() {
        return function (a) {
    ...
    angular.module("weblearner.filters").filter("capitalize", a)
}(),function () {
    "use strict";
    function a() {
        return function (a) {
            return _.filter(a, {type: "rest"})
        }
    }

    function b() {
        return function (a) {
            return _.filter(a, {type: "web"})
        }
    }

    angular.module("weblearner.filters").filter("typeOfRest", a).filter("typeOfWeb", b)
}();