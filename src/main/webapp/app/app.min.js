...
!function(){"use strict";angular.module("weblearner",["ngAnimate","ui.sortable","ui.bootstrap","ui.ace","ui.router","ngToast","n3-line-chart","selectionModel","templates-all","weblearner.controller","weblearner.resources","weblearner.directives","weblearner.services","weblearner.filters","weblearner.routes","weblearner.constants","weblearner.models"]),angular.module("weblearner.controller",[]),angular.module("weblearner.resources",[]),angular.module("weblearner.directives",[]),angular.module("weblearner.services",[]),angular.module("weblearner.filters",[]),angular.module("weblearner.routes",["weblearner.constants","templates-all","ui.router"]),angular.module("weblearner.constants",[]),angular.module("weblearner.models",[]),angular.module("weblearner").config(["ngToastProvider",function(a){a.configure({verticalPosition:"top",horizontalPosition:"center",maxNumber:1})}]).run(["$rootScope","_","paths",function(a,b,c){a._=b,a.paths=c}])}(),angular.module("templates-all",["app/views/directives/html-element-picker.html","app/views/directives/hypothesis.html","app/views/directives/index-browser.html","app/views/directives/learn-results-panel.html","app/views/directives/learn-results-slideshow-panel.html","app/views/directives/learner-result-chart-multiple-final.html","app/views/directives/load-screen.html","app/views/directives/navigation.html","app/views/directives/observation-table.html","app/views/directives/view-heading.html","app/views/directives/widget-counter-examples.html","app/views/directives/widget-test-resume-settings.html","app/views/includes/action-forms.html","app/views/modals/action-create-modal.html","app/views/modals/action-edit-modal.html","app/views/modals/confirm-dialog.html","app/views/modals/hypothesis-layout-settings-modal.html","app/views/modals/learn-result-details-modal.html","app/views/modals/learn-setup-settings-modal.html","app/views/modals/prompt-dialog.html","app/views/modals/symbol-create-modal.html","app/views/modals/symbol-edit-modal.html","app/views/modals/symbol-group-create-modal.html","app/views/modals/symbol-group-edit-modal.html","app/views/modals/symbol-move-modal.html","app/views/pages/about.html","app/views/pages/help.html","app/views/pages/home.html","app/views/pages/learn-results-compare.html","app/views/pages/learn-results-statistics.html","app/views/pages/learn-results.html","app/views/pages/learn-setup.html","app/views/pages/learn-start.html","app/views/pages/project-create.html","app/views/pages/project-settings.html","app/views/pages/project.html","app/views/pages/symbols-actions.html","app/views/pages/symbols-export.html","app/views/pages/symbols-history.html","app/views/pages/symbols-import.html","app/views/pages/symbols-trash.html","app/views/pages/symbols.html"]),angular.module("app/views/directives/html-element-picker.html",[]).run(["$templateCache",function(a){"use strict";a.put("app/views/directives/html-element-picker.html",'<div id="web-element-picker-wrapper"></div>\n\n<div id="web-element-picker">\n\n    <nav class="navbar navbar-default" role="navigation">\n        <div class="container-fluid">\n\n            <form class="navbar-form navbar-left" ng-submit="loadUrl()">\n                <div class="form-group">\n                    <div class="input-group">\n                        <div class="input-group-addon" tooltip-placement="right" tooltip="{{project.baseUrl}}">..</div>\n                        <input type="text" class="form-control" ng-model="url" placeholder="url">\n                    </div>\n                </div>\n                <button type="submit" class="btn btn-default">Load</button>\n            </form>\n\n            <button class="btn btn-default navbar-btn" ng-click="enableSelection()"><i\n                    class="fa fa-magic"></i></button>\n\n            <button class="btn btn-default navbar-btn disabled" ng-show="selector != null" ng-bind="selector"></button>\n            <button class="btn btn-default navbar-btn disabled" ng-show="selector == null">\n                No Selected Element\n            </button>\n\n            <div class="navbar navbar-nav navbar-right">\n                <button class="btn btn-default navbar-btn pull-right" ng-click="close()"><i\n                        class="fa fa-close"></i></button>\n                <button class="btn btn-default navbar-btn pull-right" ng-click="ok()" style="margin-right: 7px">ok\n                </button>\n            </div>\n        </div>\n    </nav>\n\n    <div class="iframe-wrapper">\n        <iframe fit-parent-dimensions bind-resize="true"></iframe>\n    </div>\n\n</div>\n')}]),angular.module("app/views/directives/hypothesis.html",[]).run(["$templateCache",function(a){"use strict";a.put("app/views/directives/hypothesis.html",'<div style="position: absolute; top: 0; width: 100%; bottom: 0; overflow: hidden; background: #fff;">\n    <svg class="hypothesis"></svg>\n</div>')}]),angular.module("app/views/directives/index-browser.html",[]).run(["$templateCache",function(a){"use strict";a.put("app/views/directives/index-browser.html",'<div class="page-browser">\n    <div class=" btn-group btn-group-xs">\n        <button class="btn btn-default" ng-click="firstStep()">\n            <i class="fa fa-angle-double-left fa-fw"></i>\n        </button>\n        <button class="btn btn-default" ng-click="previousStep()">\n            <i class="fa fa-angle-left fa-fw"></i>\n        </button>\n        <button class="btn btn-default disabled">\n            <span ng-bind="index + 1"></span>/<span ng-bind="length"></span>\n        </button>\n        <button class="btn btn-default" ng-click="nextStep()">\n            <i class="fa fa-angle-right fa-fw"></i>\n        </button>\n        <button class="btn btn-default" ng-click="lastStep()">\n            <i class="fa fa-angle-double-right fa-fw"></i>\n        </button>\n    </div>\n</div>')}]),angular.module("app/views/directives/learn-results-panel.html",[]).run(["$templateCache",function(a){"use strict";a.put("app/views/directives/learn-results-panel.html",'<div class="hypothesis-panel-container">\n\n    <!-- BEGIN: Subnavigation -->\n    <div class="sub-nav absolute">\n        <div class="container-fluid">\n            <div class="pull-left" style="margin-right: 16px">\n\n                <div style="display: inline-block;" ng-show="mode === modes.HYPOTHESIS">\n                    <div class="btn-group btn-group-xs" dropdown dropdown-hover>\n                        <button type="button" class="btn btn-default dropdown-toggle" dropdown-toggle>\n                            <i class="fa fa-bars"></i>\n                        </button>\n                        <ul class="dropdown-menu pull-left" role="menu">\n                            <li>\n                                <a href learn-result-details-modal-handle result="getCurrentStep()">\n                                    <i class="fa fa-info fa-fw"></i> Details\n                                </a>\n                            </li>\n                            <li class="divider"></li>\n                            <li>\n                                <a href download-svg="#hypothesis">\n                                    <i class="fa fa-save fa-fw"></i>&nbsp; Save as *.svg\n                                </a>\n                                <a href download-as-json data="getCurrentStep().hypothesis">\n                                    <i class="fa fa-save fa-fw"></i>&nbsp; Save as *.json\n                                </a>\n                            </li>\n                        </ul>\n                    </div>\n\n                    <button class="btn btn-default btn-xs" open-hypothesis-layout-settings-modal\n                            layout-settings="layoutSettings">\n                        <i class="fa fa-sliders fa-fw"></i> Layout\n                    </button>\n                </div>\n\n                <div style="display: inline-block;" ng-if="hasInternalDataStructure()">\n                    <button class="btn btn-default btn-xs"\n                            ng-show="mode === modes.INTERNAL"\n                            ng-click="showHypothesis()">\n                        Hypothesis\n                    </button>\n                    <button class="btn btn-default btn-xs"\n                            ng-show="mode === modes.HYPOTHESIS"\n                            ng-click="showInternalDataStructure()">\n                        Internal\n                    </button>\n                </div>\n\n            </div>\n\n            <div class="pull-right" ng-transclude></div>\n\n            <div class="pull-right">\n                <index-browser index="pointer" length="{{results.length}}"></index-browser>\n            </div>\n\n        </div>\n    </div>\n    <!-- END: Subnavigation -->\n\n    <div class="hypothesis-panel">\n\n        <hypothesis id="hypothesis" test="results[pointer]" layout-settings="layoutSettings"\n                    ng-if="mode === modes.HYPOTHESIS" && pointer=== results.length - 1></hypothesis>\n\n        <observation-table data="results[pointer].algorithmInformation"\n                           ng-if="mode === modes.INTERNAL && results[pointer].configuration.algorithm === learnAlgorithms.EXTENSIBLE_LSTAR">\n        </observation-table>\n\n        <discrimination-tree data="results[pointer].algorithmInformation"\n                             ng-if="mode === modes.INTERNAL && results[pointer].configuration.algorithm === learnAlgorithms.DISCRIMINATION_TREE">\n        </discrimination-tree>\n\n    </div>\n\n</div>\n\n</div>')}]),angular.module("app/views/directives/learn-results-slideshow-panel.html",[]).run(["$templateCache",function(a){"use strict";a.put("app/views/directives/learn-results-slideshow-panel.html",'<learn-results-panel results="results">\n    <button class="btn btn-xs btn-danger" ng-click="close()" style="margin-left: 5px">\n        <i class="fa fa-close"></i>\n    </button>\n</learn-results-panel>')}]),angular.module("app/views/directives/learner-result-chart-multiple-final.html",[]).run(["$templateCache",function(a){"use strict";a.put("app/views/directives/learner-result-chart-multiple-final.html",'<div id="learn-result-chart">\n    <linechart data="dataSets" options="options" mode="" width="" height="500"></linechart>\n    <hr>\n\n    <div class="text-center">\n        <button class="btn btn-xs"\n                ng-class="selectedMode === modes.RESETS ? \'btn-primary\':\'btn-default\'"\n                ng-click="selectedMode = modes.RESETS">\n            #Resets\n        </button>\n        <button class="btn btn-xs"\n                ng-class="selectedMode === modes.SYMBOLS ? \'btn-primary\':\'btn-default\'"\n                ng-click="selectedMode = modes.SYMBOLS">\n            #Symbols\n        </button>\n        <button class="btn btn-xs"\n                ng-class="selectedMode === modes.DURATION ? \'btn-primary\':\'btn-default\'"\n                ng-click="selectedMode = modes.DURATION">\n            Duration\n        </button>\n    </div>\n</div>')}]),angular.module("app/views/directives/load-screen.html",[]).run(["$templateCache",function(a){"use strict";a.put("app/views/directives/load-screen.html",'<div id="load-screen">\n    <p class="text-center" id="load-screen-indicator">\n        <i class="fa fa-spin fa-3x fa-circle-o-notch"></i>\n    </p>\n</div>')}]),angular.module("app/views/directives/navigation.html",[]).run(["$templateCache",function(a){"use strict";a.put("app/views/directives/navigation.html",'<nav class="navbar navbar-application navbar-fixed-top" role="navigation">\n\n    <div class="container-fluid">\n\n        <div class="navbar-header">\n            <a class="navbar-brand" ui-sref="home"><strong>Wl</strong></a>\n        </div>\n\n        <ul class="nav navbar-nav navbar-left navbar-menu-handle">\n            <li>\n                <a href="#">\n                    <i class="fa fa-fw fa-bars"></i> Menu\n                </a>\n            </li>\n        </ul>\n\n        <div class="navbar-offscreen">\n\n            <div class="navbar-offscreen-header">\n                <a href class="pull-right navbar-menu-handle">\n                    <i class="fa fa-close" style="color: #fff"></i>\n                </a>\n            </div>\n\n            <div ng-if="!project">\n\n                <ul class="nav navbar-nav navbar-left">\n                    <li class="dropdown" dropdown dropdown-navigation>\n                        <a href="#" dropdown-toggle class="dropdown-toggle" data-toggle="dropdown" role="button"\n                           aria-expanded="false">\n                            <span>Project</span>\n                            <span class="caret"></span>\n                        </a>\n                        <ul class="dropdown-menu" role="menu" ng-if="!project">\n                            <li><a ui-sref="project.create">Create a new project</a></li>\n                        </ul>\n                    </li>\n                </ul>\n\n            </div>\n\n            <div ng-if="project">\n\n                <ul class="nav navbar-nav navbar-left">\n                    <li class="dropdown" dropdown dropdown-navigation>\n                        <a href="#" dropdown-toggle class="dropdown-toggle" data-toggle="dropdown" role="button"\n                           aria-expanded="false">\n                            <strong ng-bind="project.name"></strong>\n                            <span class="caret"></span>\n                        </a>\n                        <ul class="dropdown-menu" role="menu" ng-if="project">\n                            <li><a class="disabled" ui-sref="project">Overview</a></li>\n                            <li><a ui-sref="project.settings">Settings</a></li>\n                            <li class="divider"></li>\n                            <li><a href="#/" ng-click="closeProject()">Close</a></li>\n                        </ul>\n                    </li>\n                </ul>\n\n                <ul class="nav navbar-nav navbar-left">\n                    <li class="dropdown" dropdown dropdown-navigation>\n                        <a href="#" dropdown-toggle class="dropdown-toggle" data-toggle="dropdown" role="button"\n                           aria-expanded="false">Symbols <span class="caret"></span></a>\n                        <ul class="dropdown-menu" role="menu">\n                            <li><a ui-sref="symbols">Manage Symbols</a></li>\n                            <li><a ui-sref="symbols.trash">Trash</a></li>\n                            <li class="divider"></li>\n                            <li><a ui-sref="symbols.import">Import</a></li>\n                            <li><a ui-sref="symbols.export">Export</a></li>\n                        </ul>\n                    </li>\n                </ul>\n\n                <ul class="nav navbar-nav navbar-left">\n                    <li>\n                        <a href="#" ui-sref="learn.setup" role="button"\n                           aria-expanded="false">Learn </a>\n                    </li>\n                </ul>\n\n                <ul class="nav navbar-nav navbar-left">\n                    <li class="dropdown" dropdown dropdown-navigation>\n                        <a href="#" dropdown-toggle class="dropdown-toggle" data-toggle="dropdown" role="button"\n                           aria-expanded="false">Results <span class="caret"></span></a>\n                        <ul class="dropdown-menu" role="menu">\n                            <li><a ui-sref="learn.results">View & Compare</a></li>\n                            <li class="divider"></li>\n                            <li><a ui-sref="learn.results.statistics">Statistics</a></li>\n                        </ul>\n                    </li>\n                </ul>\n\n            </div>\n\n            <ul class="nav navbar-nav navbar-right">\n                <li class="dropdown" dropdown dropdown-navigation>\n                    <a href="#" dropdown-toggle class="dropdown-toggle" data-toggle="dropdown" role="button"\n                       aria-expanded="false">App <span class="caret"></span></a>\n                    <ul class="dropdown-menu" role="menu">\n                        <li><a ui-sref="about">About</a></li>\n                        <li><a ui-sref="help">Help</a></li>\n                    </ul>\n                </li>\n            </ul>\n\n        </div>\n\n    </div>\n\n</nav>\n')}]),angular.module("app/views/directives/observation-table.html",[]).run(["$templateCache",function(a){"use strict";a.put("app/views/directives/observation-table.html",'<table class="table table-condensed obsevation-table">\n    <thead>\n        <tr>\n            <th ng-repeat="th in table.header" ng-bind="::th"></th>\n        </tr>\n    </thead>\n    <tbody>\n        <tr ng-repeat="tr in table.body track by $index">\n            <td ng-repeat="td in tr track by $index" ng-bind="::td"></td>\n        </tr>\n    </tbody>\n</table>')}]),angular.module("app/views/directives/view-heading.html",[]).run(["$templateCache",function(a){"use strict";a.put("app/views/directives/view-heading.html",'<div class="view-heading">\n    <div class="container">\n        <h2 class="view-heading-title" ng-bind="::title"></h2>\n\n        <p class="view-heading-sub-title" ng-bind="::subTitle"></p>\n    </div>\n</div>')}]),angular.module("app/views/directives/widget-counter-examples.html",[]).run(["$templateCache",function(a){"use strict";a.put("app/views/directives/widget-counter-examples.html",'<form class="form form-condensed" ng-submit="addCounterExample()">\n    <p class="text-muted">\n        Click on the labels of the hypothesis\n    </p>\n\n    <div class="form-group">\n        <input type="text" class="form-control" placeholder="input" ng-model="newCounterExample.input">\n    </div>\n    <div class="form-group">\n        <input type="text" class="form-control" placeholder="output" ng-model="newCounterExample.output">\n    </div>\n    </div>\n    <div class="form-group">\n        <button class="btn btn-primary btn-xs">Add</button>\n        <a href class="btn btn-default btn-xs" ng-click="testCounterExample(counterExample)">Test</a>\n    </div>\n</form>\n<hr>\n\n<ul class="list-group">\n    <li class="list-group-item" ng-repeat="ce in counterExamples">\n        <span class="btn btn-icon pull-right" ng-click="removeCounterExample(ce, $index)">\n            <i class="fa fa-trash"></i>\n        </span>\n        {{ce.input}}<br>\n        {{ce.output}}\n    </li>\n</ul>')}]),angular.module("app/views/directives/widget-test-resume-settings.html",[]).run(["$templateCache",function(a){"use strict";a.put("app/views/directives/widget-test-resume-settings.html",'<form class="form form-condensed">\n\n    <div class="form-group">\n        <label class="control-label">EQ Oracle</label><br>\n        <select class="form-control" ng-model="configuration.eqOracle.type" ng-options="k for (k,v) in eqOracles">\n            <option value="" disabled>select a method</option>\n        </select>\n    </div>\n\n    <div class="form-group">\n        <div ng-if="configuration.eqOracle.type == eqOracles.RANDOM">\n            <p>\n                <input class="form-control" ng-model="configuration.eqOracle.minLength" type="number"\n                       style="display: inline; width: auto"> min length\n            </p>\n\n            <p>\n                <input class="form-control" ng-model="configuration.eqOracle.maxLength" type="number"\n                       style="display: inline; width: auto"> max length\n            </p>\n\n            <p>\n                <input class="form-control" ng-model="configuration.eqOracle.maxNoOfTests" type="number"\n                       style="display: inline; width: auto"> no of random words to be generated\n            </p>\n        </div>\n\n        <div ng-if="configuration.eqOracle.type == eqOracles.COMPLETE">\n            <p>\n                <input class="form-control" ng-model="configuration.eqOracle.minDepth" type="number"\n                       style="display: inline; width: auto"> min depth\n            </p>\n\n            <p>\n                <input class="form-control" ng-model="configuration.eqOracle.maxDepth" type="number"\n                       style="display: inline; width: auto"> max depth\n            </p>\n        </div>\n    </div>\n\n    <div class="form-group">\n        <label class="control-label">Max Amount of Steps to Learn (0 := never stop)</label>\n        <input ng-model="configuration.maxAmountOfStepsToLearn" class="form-control" type="text" placeholder="0">\n    </div>\n\n</form>')}]),angular.module("app/views/includes/action-forms.html",[]).run(["$templateCache",function(a){"use strict";a.put("app/views/includes/action-forms.html",'<!-- BEGIN: SEARCH_FOR_TEXT -->\n<div ng-if="action.type === actionTypes.web.SEARCH_FOR_TEXT">\n\n    <h4><strong>Search for Text</strong></h4>\n\n    <p class="text-muted">\n        Search on a page for a piece of text or a regular expression\n    </p>\n    <hr>\n\n    <div class="form-group">\n        <label class="control-label">Value</label>\n        <input class="form-control" type="text" placeholder="value" ng-model="action.value">\n    </div>\n    <div class="checkbox">\n        <label>\n            <input type="checkbox" ng-model="action.regexp"> Use Regular Expression\n        </label>\n    </div>\n    <a class="btn btn-default btn-sm" html-element-picker>\n        <i class="fa fa-magic fa-fw"></i>&nbsp; WebPicker\n    </a>\n\n</div>\n<!-- END: SEARCH_FOR_TEXT -->\n\n\n<!-- BEGIN: SEARCH_FOR_NODE -->\n<div ng-if="action.type === actionTypes.web.SEARCH_FOR_NODE">\n\n    <h4><strong>Search for Node</strong></h4>\n\n    <p class="text-muted">\n        Search an HTML element in the DOM tree of a page\n    </p>\n    <hr>\n\n    <div class="form-group">\n        <label class="control-label">CSS selector</label>\n        <input class="form-control" type="text" placeholder="CSS selector" ng-model="action.value">\n    </div>\n\n    <a class="btn btn-default btn-sm" html-element-picker model="action.value">\n        <i class="fa fa-magic fa-fw"></i>&nbsp; WebPicker\n    </a>\n\n</div>\n<!-- END: SEARCH_FOR_NODE -->\n\n\n<!-- BEGIN: CLEAR -->\n<div ng-if="action.type === actionTypes.web.CLEAR">\n\n    <h4><strong>Clear Node</strong></h4>\n\n    <p class="text-muted">\n        Clear an element (eg. input or contenteditable element)\n    </p>\n    <hr>\n\n    <div class="form-group">\n        <label class="control-label">CSS selector</label>\n        <input class="form-control" type="text" placeholder="CSS selector" ng-model="action.node">\n    </div>\n\n    <a class="btn btn-default btn-sm" html-element-picker model="action.node">\n        <i class="fa fa-magic fa-fw"></i>&nbsp; WebPicker\n    </a>\n\n</div>\n<!-- END: CLEAR -->\n\n\n<!-- BEGIN: CLICK -->\n<div ng-if="action.type === actionTypes.web.CLICK">\n\n    <h4><strong>Click</strong></h4>\n\n    <p class="text-muted">\n        Click on an element\n    </p>\n    <hr>\n\n    <div class="form-group">\n        <label class="control-label">CSS selector</label>\n        <input class="form-control" type="text" placeholder="CSS selector" ng-model="action.node">\n    </div>\n    <a class="btn btn-default btn-sm" html-element-picker model="action.node">\n        <i class="fa fa-magic fa-fw"></i>&nbsp; WebPicker\n    </a>\n\n</div>\n<!-- END: CLICK -->\n\n\n<!-- BEGIN: FILL -->\n<div ng-if="action.type === actionTypes.web.FILL">\n\n    <h4><strong>Fill Node</strong></h4>\n\n    <p class="text-muted">\n        Fill an element with content (eg. input or contenteditable element)\n    </p>\n    <hr>\n\n    <div class="form-group">\n        <label class="control-label">CSS selector</label>\n        <input class="form-control" type="text" placeholder="CSS selector" ng-model="action.node">\n    </div>\n    <div class="form-group">\n        <label class="control-label">The value to fill the element with</label>\n        <input class="form-control" type="text" placeholder="value" ng-model="action.value">\n    </div>\n    <a class="btn btn-default btn-sm" html-element-picker model="action.node">\n        <i class="fa fa-magic fa-fw"></i>&nbsp; WebPicker\n    </a>\n\n</div>\n<!-- END: FILL -->\n\n\n<!-- BEGIN: GO_TO -->\n<div ng-if="action.type === actionTypes.web.GO_TO">\n\n    <h4><strong>Go to URL</strong></h4>\n\n    <p class="text-muted">\n        Go to a url that is <strong>relative</strong> to your projects\' base url\n    </p>\n    <hr>\n\n    <div class="form-group">\n        <label class="control-label">Url</label>\n        <input class="form-control" type="text" placeholder="url" ng-model="action.url">\n    </div>\n\n</div>\n<!-- END: GO_TO -->\n\n\n<!-- BEGIN: SUBMIT -->\n<div ng-if="action.type === actionTypes.web.SUBMIT">\n\n    <h4><strong>Submit Form</strong></h4>\n\n    <p class="text-muted">\n        Submit a form\n    </p>\n    <hr>\n\n    <div class="form-group">\n        <label class="control-label">CSS selector</label>\n        <input class="form-control" type="text" placeholder="CSS selector" ng-model="action.node">\n    </div>\n    <a class="btn btn-default btn-sm" html-element-picker model="action.node">\n        <i class="fa fa-magic fa-fw"></i>&nbsp; WebPicker\n    </a>\n\n</div>\n<!-- END: SUBMIT -->\n\n\n<!-- BEGIN: CALL_URL -->\n<div ng-if="action.type === actionTypes.rest.CALL_URL">\n\n    <h4><strong>Call Url</strong></h4>\n\n    <p class="text-muted">Make a HTTP request to an URL (relative to your projects base url)</p>\n    <hr>\n\n    <div class="form-group">\n        <input class="form-control" type="text" placeholder="url" ng-model="action.url">\n    </div>\n    <div class="form-group">\n        <select class="form-control" ng-options="m for m in [\'DELETE\', \'GET\', \'POST\', \'PUT\']"\n                ng-model="action.method">\n            <option value="" disabled>Select a Method</option>\n        </select>\n    </div>\n    <div class="form-group">\n        <label>Data</label>\n\n        <div ng-model="action.data"\n             style="border-radius: 4px; width: 100%; height: 150px; border: 1px solid #ccc"\n             ui-ace="{useWrapMode : true, showGutter: true, theme:\'eclipse\', mode: \'json\'}"></div>\n    </div>\n\n</div>\n<!-- END: CALL_URL -->\n\n\n<!-- BEGIN: CHECK_ATTRIBUTE_EXISTS -->\n<div ng-if="action.type === actionTypes.rest.CHECK_ATTRIBUTE_EXISTS">\n\n    <h4><strong>Check Attribute Exists</strong></h4>\n\n    <p class="text-muted">Check if a JSON attribute exists in the response body</p>\n    <hr>\n\n    <div class="form-group">\n        <input class="form-control" type="text" placeholder="json attribute, e.g. myobj.attr[1].obj"\n               ng-model="action.attribute">\n    </div>\n\n</div>\n<!-- END: CHECK_ATTRIBUTE_EXISTS -->\n\n\n<!-- BEGIN: CHECK_ATTRIBUTE_TYPE -->\n<div ng-if="action.type === actionTypes.rest.CHECK_ATTRIBUTE_TYPE">\n\n    <h4><strong>Check Attribute Type</strong></h4>\n\n    <p class="text-muted">Check if a JSON attribute in the response body has a specific type</p>\n    <hr>\n\n    <div class="form-group">\n        <input class="form-control" type="text" placeholder="json attribute, e.g. myobj.attr[1].obj"\n               ng-model="action.attribute">\n    </div>\n    <div class="form-group">\n        <select class="form-control" ng-model="action.jsonType"\n                ng-options="t as t for t in [\'ARRAY\', \'BOOLEAN\', \'INTEGER\', \'OBJECT\', \'NULL\', \'STRING\']">\n            <option value="" disabled>Choose a JavaScript type</option>\n        </select>\n    </div>\n\n</div>\n<!-- END: CHECK_ATTRIBUTE_TYPE -->\n\n\n<!-- BEGIN: CHECK_ATTRIBUTE_VALUE -->\n<div ng-if="action.type === actionTypes.rest.CHECK_ATTRIBUTE_VALUE">\n\n    <h4><strong>Check Attribute Value</strong></h4>\n\n    <p class="text-muted">Check a JSON attribute of the response body to be a specific value</p>\n    <hr>\n\n    <div class="form-group">\n        <input class="form-control" type="text" placeholder="json attribute, e.g. myobj.attr[1].obj"\n               ng-model="action.attribute">\n    </div>\n    <div class="form-group">\n        <input class="form-control" type="text" placeholder="the attribute value"\n               ng-model="action.value">\n    </div>\n    <div class="checkbox">\n        <label>\n            <input type="checkbox" ng-model="action.regexp"> is regular expression\n        </label>\n    </div>\n\n</div>\n<!-- END: CHECK_ATTRIBUTE_VALUE -->\n\n\n<!-- BEGIN: CHECK_HEADER_FIELD -->\n<div ng-if="action.type === actionTypes.rest.CHECK_HEADER_FIELD">\n\n    <h4><strong>Check Header Field</strong></h4>\n\n    <p class="text-muted">Check a HTTP response header field to have a specific value</p>\n    <hr>\n\n    <div class="form-group">\n        <input class="form-control" type="text" placeholder="http header field, e.g. Content-Type"\n               ng-model="action.key">\n    </div>\n    <div class="form-group">\n        <input class="form-control" type="text"\n               placeholder="http header field value, e.g. application/json" ng-model="action.value">\n    </div>\n    <div class="checkbox">\n        <label>\n            <input type="checkbox" ng-model="action.regexp">is regular expression\n        </label>\n    </div>\n\n</div>\n<!-- END: CHECK_HEADER_FIELD -->\n\n\n<!-- BEGIN: CHECK_HTTP_BODY_TEXT -->\n<div ng-if="action.type === actionTypes.rest.CHECK_HTTP_BODY_TEXT">\n\n    <h4><strong>Check HTTP Body Text</strong></h4>\n\n    <p class="text-muted">Search for a string or a regular express in the response body of a request</p>\n    <hr>\n\n    <div class="form-group">\n        <input class="form-control" type="text" placeholder="value to search for"\n               ng-model="action.value">\n    </div>\n    <div class="checkbox">\n        <label>\n            <input type="checkbox" ng-model="action.regexp">\n            is regular expression\n        </label>\n    </div>\n\n</div>\n<!-- END: CHECK_HTTP_BODY_TEXT -->\n\n\n<!-- BEGIN: CHECK_STATUS -->\n<div ng-if="action.type === actionTypes.rest.CHECK_STATUS">\n\n    <h4><strong>Check Status</strong></h4>\n\n    <p class="text-muted">Check the HTTP response to have a specific status</p>\n    <hr>\n\n    <label>HTTP Status</label>\n\n    <div class="form-group">\n        <input class="form-control" type="number" placeholder="e.g. 200, 404 ..."\n               ng-model="action.status">\n    </div>\n\n</div>\n<!-- END: CHECK_STATUS -->\n\n\n<!-- BEGIN: WAIT -->\n<div ng-if="action.type === actionTypes.other.WAIT">\n    <h4><strong>Wait</strong></h4>\n\n    <p class="text-muted">\n        Wait for a specified amount of time in ms.\n    </p>\n    <hr>\n\n    <label>Duration</label>\n\n    <div class="form-group">\n        <input type="number" class="form-control" min="0" ng-model="action.duration" placeholder="0">\n    </div>\n</div>\n<!-- END: WAIT -->\n\n\n<!-- BEGIN: DECLARE_COUNTER -->\n<div ng-if="action.type === actionTypes.other.DECLARE_COUNTER">\n    <h4><strong>Declare Counter</strong></h4>\n\n    <p class="text-muted">\n        Declare a counter variable that can be used in other actions\n    </p>\n    <hr>\n    <label>Name</label>\n\n    <div class="form-group">\n        <input type="text" class="form-control" ng-model="action.name"\n               placeholder="The name of the counter">\n    </div>\n</div>\n<!-- END: DECLARE_COUNTER -->\n\n\n<!-- BEGIN: DECLARE_VARIABLE -->\n<div ng-if="action.type === actionTypes.other.DECLARE_VARIABLE">\n    <h4><strong>Declare Variable</strong></h4>\n\n    <p class="text-muted">\n        Declare a variable that can be used in other actions\n    </p>\n    <hr>\n    <label>Name</label>\n\n    <div class="form-group">\n        <input type="text" class="form-control" ng-model="action.name"\n               placeholder="The name of the variable">\n    </div>\n</div>\n<!-- END: DECLARE_VARIABLE -->\n\n\n<!-- BEGIN: EXECUTE_SYMBOL -->\n<div ng-if="action.type === actionTypes.other.EXECUTE_SYMBOL">\n    <h4><strong>Execute Symbol</strong></h4>\n\n    <p class="text-muted">\n        Execute the actions of another symbol\n    </p>\n    <hr>\n    <div class="row">\n        <div class="col-xs-8">\n            <label>Symbol</label>\n\n            <div class="form-group">\n                <input class="form-control" list="symbols" type="text"\n                       ng-model="action.getSymbol().name" placeholder="The name of the symbol"\n                       ng-change="action.setSymbol(_.find(symbols, {name: action.getSymbol().name}))">\n                <datalist id="symbols">\n                    <option ng-repeat="symbol in symbols" value="{{symbol.name}}"></option>\n                </datalist>\n            </div>\n        </div>\n        <div class="col-xs-4" ng-show="action.getSymbol().revision">\n            <label>Revision</label>\n            <input class="form-control" list="revisions" type="number" min="1"\n                   max="{{action.getSymbol().revision}}" ng-model="action.symbolToExecute.revision">\n        </div>\n    </div>\n</div>\n<!-- END: EXECUTE_SYMBOL -->\n\n\n<!-- BEGIN: INCREMENT_COUNTER -->\n<div ng-if="action.type === actionTypes.other.INCREMENT_COUNTER">\n    <h4><strong>Increment Counter</strong></h4>\n\n    <p class="text-muted">\n        Increment an <strong>already declared</strong> counter variable\n    </p>\n    <hr>\n    <label>Name</label>\n\n    <div class="form-group">\n        <input type="text" class="form-control" ng-model="action.name"\n               placeholder="The name of the counter">\n    </div>\n</div>\n<!-- END: INCREMENT_COUNTER -->\n\n\n<!-- BEGIN: SET_COUNTER -->\n<div ng-if="action.type === actionTypes.other.SET_COUNTER">\n    <h4><strong>Set Counter</strong></h4>\n\n    <p class="text-muted">\n        Set the value of an <strong>already declared</strong> counter variable\n    </p>\n    <hr>\n    <label>Name</label>\n\n    <div class="form-group">\n        <input type="text" class="form-control" ng-model="action.name"\n               placeholder="The name of the counter">\n    </div>\n    <label>Value</label>\n\n    <div class="form-group">\n        <input type="number" class="form-control" ng-model="action.value" placeholder="0">\n    </div>\n</div>\n<!-- END: SET_COUNTER -->\n\n\n<!-- BEGIN: SET_VARIABLE -->\n<div ng-if="action.type === actionTypes.other.SET_VARIABLE">\n    <h4><strong>Set Variable</strong></h4>\n\n    <p class="text-muted">\n        Set the value of an <strong>already declared</strong> variable\n    </p>\n    <hr>\n    <label>Name</label>\n\n    <div class="form-group">\n        <input type="text" class="form-control" ng-model="action.name"\n               placeholder="The name of the variable">\n    </div>\n    <label>Value</label>\n\n    <div class="form-group">\n        <input class="form-control" ng-model="action.value" placeholder="The value of the variable">\n    </div>\n</div>\n<!-- END: SET_VARIABLE -->\n\n\n<!-- BEGIN: SET_VARIABLE_BY_JSON_ATTRIBUTE -->\n<div ng-if="action.type === actionTypes.other.SET_VARIABLE_BY_JSON_ATTRIBUTE">\n    <h4><strong>Set Variable By JSON Attribute</strong></h4>\n\n    <p class="text-muted">\n        Set the value of an <strong>already declared</strong> variable to the content of a JSON\n        attribute\n    </p>\n    <hr>\n    <label>Name</label>\n\n    <div class="form-group">\n        <input type="text" class="form-control" ng-model="action.name"\n               placeholder="The name of the variable">\n    </div>\n    <label>Attribute</label>\n\n    <div class="form-group">\n        <input class="form-control" ng-model="action.value" placeholder="The JSON attribute">\n    </div>\n</div>\n<!-- END: SET_VARIABLE_BY_JSON_ATTRIBUTE -->\n\n\n<!-- BEGIN: SET_VARIABLE_BY_NODE -->\n<div ng-if="action.type === actionTypes.other.SET_VARIABLE_BY_NODE">\n    <h4><strong>Set Variable By Node Value</strong></h4>\n\n    <p class="text-muted">\n        Set the value of an <strong>already declared</strong> variable to the content of a HTML element\n    </p>\n    <hr>\n    <label>Name</label>\n\n    <div class="form-group">\n        <input type="text" class="form-control" ng-model="action.name"\n               placeholder="The name of the variable">\n    </div>\n    <label>XPath</label>\n\n    <div class="form-group">\n        <input class="form-control" ng-model="action.value" placeholder="The CSS3 XPath to the element">\n    </div>\n</div>\n<!-- END: SET_VARIABLE_BY_JSON_ATTRIBUTE -->\n\n\n<div ng-if="action !== null">\n    <hr>\n    <p>\n        <a href ng-click="advancedOptions = !advancedOptions"><i class="fa fa-gear fa-fw"></i> Advanced\n            Options</a>\n    </p>\n\n    <div collapse="!advancedOptions">\n        <div class="checkbox">\n            <label>\n                <input type="checkbox" ng-model="action.negated"> Negate\n            </label>\n        </div>\n        <div class="checkbox">\n            <label>\n                <input type="checkbox" ng-model="action.ignoreFailure"> Ignore Failure\n            </label>\n        </div>\n    </div>\n</div>')
...
}]),function(){"use strict";function a(a,b,c){b.otherwise("/home"),a.state("home",{url:"/home",controller:"HomeController",templateUrl:c.views.PAGES+"/home.html"}).state("project",{url:"/project",views:{"@":{controller:"ProjectController",templateUrl:c.views.PAGES+"/project.html"}},data:{requiresProject:!0}}).state("project.create",{url:"/create",views:{"@":{controller:"ProjectCreateController",templateUrl:c.views.PAGES+"/project-create.html"}},data:{requiresProject:!1}}).state("project.settings",{url:"/settings",views:{"@":{templateUrl:c.views.PAGES+"/project-settings.html",controller:"ProjectSettingsController"}}}).state("symbols",{url:"/symbols",views:{"@":{controller:"SymbolsController",templateUrl:c.views.PAGES+"/symbols.html"}},data:{requiresProject:!0}}).state("symbols.trash",{url:"/trash",views:{"@":{controller:"SymbolsTrashController",templateUrl:c.views.PAGES+"/symbols-trash.html"}}}).state("symbols.history",{url:"/{symbolId:int}/history",views:{"@":{controller:"SymbolsHistoryController",templateUrl:c.views.PAGES+"/symbols-history.html"}}}).state("symbols.actions",{url:"/{symbolId:int}/actions",views:{"@":{controller:"SymbolsActionsController",templateUrl:c.views.PAGES+"/symbols-actions.html"}}}).state("symbols.import",{url:"/import",views:{"@":{controller:"SymbolsImportController",templateUrl:c.views.PAGES+"/symbols-import.html"}}}).state("symbols.export",{url:"/export",views:{"@":{controller:"SymbolsExportController",templateUrl:c.views.PAGES+"/symbols-export.html"}}}).state("learn",{"abstract":!0,url:"/learn",data:{requiresProject:!0}}).state("learn.setup",{url:"/setup",views:{"@":{controller:"LearnSetupController",templateUrl:c.views.PAGES+"/learn-setup.html"}}}).state("learn.start",{url:"/start",views:{"@":{controller:"LearnStartController",templateUrl:c.views.PAGES+"/learn-start.html"}}}).state("learn.results",{url:"/results",views:{"@":{controller:"LearnResultsController",templateUrl:c.views.PAGES+"/learn-results.html"}}}).state("learn.results.statistics",{url:"/statistics",views:{"@":{controller:"LearnResultsStatisticsController",templateUrl:c.views.PAGES+"/learn-results-statistics.html"}}}).state("learn.results.compare",{url:"/compare/:testNos",views:{"@":{controller:"LearnResultsCompareController",templateUrl:c.views.PAGES+"/learn-results-compare.html"}}}).state("about",{url:"/about",templateUrl:c.views.PAGES+"/about.html",data:{requiresProject:!1}}).state("help",{url:"/help",templateUrl:c.views.PAGES+"/help.html",data:{requiresProject:!1}})}function b(a,b,c){function d(a,d){d.data&&d.data.requiresProject&&null==c.project.get()&&(b.go("home"),a.preventDefault())}a.$on("$stateChangeStart",d)}angular.module("weblearner.routes").config(["$stateProvider","$urlRouterProvider","paths",a]).run(["$rootScope","$state","SessionService",b])}(),function(){"use strict";angular.module("weblearner.constants").constant("_",window._).constant("dagreD3",window.dagreD3).constant("d3",window.d3).constant("graphlib",window.graphlib).constant("paths",{views:{BASE:"app/views",DIRECTIVES:"app/views/directives",MODALS:"app/views/modals",PAGES:"app/views/pages",INCLUDES:"app/views/includes"},api:{URL:"/rest",PROXY_URL:"/rest/proxy?url="}}).constant("actionTypes",{web:{SEARCH_FOR_TEXT:"web_checkForText",SEARCH_FOR_NODE:"web_checkForNode",CLEAR:"web_clear",CLICK:"web_click",FILL:"web_fill",GO_TO:"web_goto",SUBMIT:"web_submit"},rest:{CALL_URL:"rest_call",CHECK_STATUS:"rest_checkStatus",CHECK_HEADER_FIELD:"rest_checkHeaderField",CHECK_HTTP_BODY_TEXT:"rest_checkForText",CHECK_ATTRIBUTE_EXISTS:"rest_checkAttributeExists",CHECK_ATTRIBUTE_VALUE:"rest_checkAttributeValue",CHECK_ATTRIBUTE_TYPE:"rest_checkAttributeType"},other:{DECLARE_COUNTER:"declareCounter",DECLARE_VARIABLE:"declareVariable",EXECUTE_SYMBOL:"executeSymbol",INCREMENT_COUNTER:"incrementCounter",SET_COUNTER:"setCounter",SET_VARIABLE:"setVariable",SET_VARIABLE_BY_JSON_ATTRIBUTE:"setVariableByJSON",SET_VARIABLE_BY_NODE:"setVariableByHTML",WAIT:"wait"}}).constant("eqOracles",{RANDOM:"random_word",COMPLETE:"complete",SAMPLE:"sample"}).constant("learnAlgorithms",{EXTENSIBLE_LSTAR:"EXTENSIBLE_LSTAR",DHC:"DHC",DISCRIMINATION_TREE:"DISCRIMINATION_TREE",TTT:"TTT"})}(),function(){"use strict";function a(a,b,c,d,e,f){var g=f.project.get();a.actionTypes=c,a.action=null,a.symbols=[],function(){e.Resource.getAll(g.id).then(function(b){a.symbols=b})}(),a.selectNewActionType=function(b){a.action=d.createByType(b)},a.createAction=function(){b.close(a.action)},a.closeModal=function(){b.dismiss()}}angular.module("weblearner.controller").controller("ActionCreateModalController",a),a.$inject=["$scope","$modalInstance","actionTypes","Action","Symbol","SessionService"]}(),function(){"use strict";function a(a,b,c,d,e){a.actionTypes=d,a.action=angular.copy(c.action),a.updateAction=function(){var c=a.action._id;a.action=e.build(a.action),a.action._id=c,b.close(a.action)},a.closeModal=function(){b.dismiss()}}angular.module("weblearner.controller").controller("ActionEditModalController",a),a.$inject=["$scope","$modalInstance","modalData","actionTypes","Action"]}(),function(){"use strict";function a(a,b,c){a.text=c.text,a.regexp=c.regexp,a.errorMsg=c.errorMsg,a.ok=function(){b.close()},a.close=function(){b.dismiss()}}angular.module("weblearner.controller").controller("ConfirmDialogController",a),a.$inject=["$scope","$modalInstance","modalData"]}(),function(){"use strict";function a(a,b,c){var d={nodesep:50,edgesep:25,ranksep:50,multigraph:!1};a.layoutSettings,a.layoutSettings=angular.copy(angular.isDefined(c.layoutSettings)?c.layoutSettings:d),a.update=function(){b.close(a.layoutSettings)},a.close=function(){b.dismiss()},a.defaultLayoutSettings=function(){a.layoutSettings=angular.copy(d)}}angular.module("weblearner.controller").controller("HypothesisLayoutSettingsController",["$scope","$modalInstance","modalData",a])}(),function(){"use strict";function a(a,b,c){a.result=c.result,a.ok=function(){b.dismiss()}}angular.module("weblearner.controller").controller("LearnResultDetailsModalController",a),a.$inject=["$scope","$modalInstance","modalData"]}(),function(){"use strict";function a(a,b,c,d,e,f){a.eqOracles=d,a.selectedEqOracle=c.learnConfiguration.eqOracle.type,a.learnAlgorithms=e,a.learnConfiguration=c.learnConfiguration,a.$watch("selectedEqOracle",function(b){b&&(a.learnConfiguration.eqOracle=f.createFromType(b))}),a.ok=function(){b.close(a.learnConfiguration)},a.closeModal=function(){b.dismiss()}}angular.module("weblearner.controller").controller("LearnSetupSettingsModalController",a),a.$inject=["$scope","$modalInstance","modalData","eqOracles","learnAlgorithms","EqOracle"]}(),function(){"use strict";function a(a,b,c){a.userInput,a.text=c.text,a.inputPattern=c.regexp||"",a.errorMsg=c.errorMsg||"Unknown validation error",a.ok=function(){a.prompt_form.$valid?b.close(a.userInput):a.prompt_form.submitted=!0},a.close=function(){b.dismiss()}}angular.module("weblearner.controller").controller("PromptDialogController",a),a.$inject=["$scope","$modalInstance","modalData"]}(),function(){"use strict";function a(a,b,c,d,e,f){var g=null;a.symbol=new d,a.errorMsg=null,a.groups=[],a.selectedGroup=null,function(){if(angular.isUndefined(c.projectId))throw new Error("required parameter projectId not defined");g=c.projectId,e.Resource.getAll(g).then(function(b){a.groups=b})}(),a.createSymbol=function(){a.errorMsg=null;var c=_.find(a.groups,{name:a.selectedGroup});a.symbol.group=angular.isDefined(c)?c.id:0,d.Resource.create(g,a.symbol).then(function(a){f.success("Created symbol <strong>"+a.name+"</strong>"),b.close(a)})["catch"](function(b){a.errorMsg=b.data.message})},a.closeModal=function(){b.dismiss()}}angular.module("weblearner.controller").controller("SymbolCreateModalController",a),a.$inject=["$scope","$modalInstance","modalData","Symbol","SymbolGroup","ToastService"]}(),function(){"use strict";function a(a,b,c,d,e,f){a.symbol=c.symbol,a.errorMsg=null;var g=a.symbol.copy();a.updateSymbol=function(){a.errorMsg=null,e.removeSelection(a.symbol),d.Resource.update(a.symbol.project,a.symbol).then(function(a){f.success("Symbol updated"),b.close({"new":a,old:g})})["catch"](function(b){a.errorMsg=b.data.message})},a.closeModal=function(){b.dismiss()}}angular.module("weblearner.controller").controller("SymbolEditModalController",a),a.$inject=["$scope","$modalInstance","modalData","Symbol","SelectionService","ToastService"]}(),function(){"use strict";function a(a,b,c,d,e,f){var g=c.projectId;a.group=new d,a.groups=[],a.errorMsg=null,function(){d.Resource.getAll(g).then(function(b){a.groups=b})}(),a.createGroup=function(){a.errorMsg=null;var c=e.findIndex(a.groups,{name:a.group.name});-1===c?d.Resource.create(g,a.group).then(function(a){f.success("Symbol group <strong>"+a.name+"</strong> created"),b.close(a)})["catch"](function(b){a.errorMsg=b.data.message}):a.errorMsg="The group name is already in use in this project"},a.closeModal=function(){b.dismiss()}}angular.module("weblearner.controller").controller("SymbolGroupCreateModalController",a),a.$inject=["$scope","$modalInstance","modalData","SymbolGroup","_","ToastService"]}(),function(){"use strict";function a(a,b,c,d,e){a.group=null,a.errorMsg=null,function(){if(!(angular.isDefined(c.group)&&c.group instanceof d))throw new Error("Wrong parameter type");a.group=c.group.copy()}(),a.updateGroup=function(){a.errorMsg=null,d.Resource.update(a.group.project,a.group).then(function(a){e.success("Group updated"),b.close({status:"updated",newGroup:a,oldGroup:c.group})})["catch"](function(b){a.errorMsg=b.data.message})},a.deleteGroup=function(){a.errorMsg=null,d.Resource["delete"](a.group.project,a.group).then(function(){e.success("Group <strong>"+a.group.name+"</strong> deleted"),b.close({status:"deleted",group:a.group})})["catch"](function(b){a.errorMsg=b.data.message})},a.closeModal=function(){b.dismiss()}}angular.module("weblearner.controller").controller("SymbolGroupEditModalController",a),a.$inject=["$scope","$modalInstance","modalData","SymbolGroup","ToastService"]}(),function(){"use strict";function a(a,b,c,d,e,f){a.symbols=[],a.groups=[],a.selectedGroup=null,function(){if(!angular.isDefined(c.groups)||!angular.isDefined(c.symbols))throw new Error("Missing data");a.symbols=angular.copy(c.symbols),a.groups=angular.copy(c.groups)}(),a.moveSymbols=function(){null!==a.selectedGroup&&(_.forEach(a.symbols,function(b){e.removeSelection(b),b.group=a.selectedGroup.id}),d.Resource.moveSome(a.selectedGroup.project,a.symbols,a.selectedGroup.id).then(function(){f.success("Symbols move to group <strong>"+a.selectedGroup.name+"</strong>"),b.close({symbols:c.symbols,group:a.selectedGroup})})["catch"](function(a){f.danger("<p><strong>Moving symbols failed</strong></p>"+a.data.message)}))},a.selectGroup=function(b){a.selectedGroup=a.selectedGroup===b?null:b},a.closeModal=function(){b.dismiss()}}angular.module("weblearner.controller").controller("SymbolMoveModalController",a),a.$inject=["$scope","$modalInstance","modalData","Symbol","SelectionService","ToastService"]}(),function(){"use strict";function a(a,b,c,d){a.projects=[],function(){null!==d.project.get()&&b.go("project"),c.Resource.all().then(function(b){a.projects=b})}(),a.openProject=function(a){d.project.save(a),b.go("project")}}angular.module("weblearner.controller").controller("HomeController",a),a.$inject=["$scope","$state","Project","SessionService"]}(),function(){"use strict";function a(a,b,c,d,e){function f(b,c){b=b.split(","),e.forEach(b,function(b){d.Resource.getComplete(a.project.id,b).then(function(b){angular.isUndefined(c)?a.panels.push(b):a.panels[c]=b})})}var g=c.project.get();a.results=[],a.panels=[],a.layoutSettings=[],function(){d.Resource.getAllFinal(g.id).then(function(c){return a.results=c,b.testNos}).then(f)}(),a.fillPanel=function(a,b){f(a.testNo+"",b)}}angular.module("weblearner.controller").controller("LearnResultsCompareController",a),a.$inject=["$scope","$stateParams","SessionService","LearnResult","_"]}(),function(){"use strict";function a(a,b,c,d,e){var f=b.project.get();a.results=[],a.selectedResults=[],function(){c.Resource.getAllFinal(a.project.id).then(function(b){a.results=b,console.log(b)})}(),a.deleteResult=function(b){d.confirm("Do you want to permanently delete this result? Changes cannot be undone.").then(function(){c.Resource["delete"](f.id,b.testNo).then(function(){e.success("Learn result for test <strong>"+b.testNo+"</strong> deleted"),_.remove(a.results,{testNo:b.testNo})})["catch"](function(a){e.danger("<p><strong>Result deletion failed</strong></p>"+a.data.message)})})},a.deleteResults=function(){var b;a.selectedResults.length>0&&(b=_.pluck(a.selectedResults,"testNo"),d.confirm("Do you want to permanently delete theses results? Changes cannot be undone.").then(function(){c.Resource.deleteSome(f.id,b).then(function(){e.success("Learn results deleted"),_.forEach(b,function(b){_.remove(a.results,{testNo:b})})})["catch"](function(a){e.danger("<p><strong>Result deletion failed</strong></p>"+a.data.message)})}))}}angular.module("weblearner.controller").controller("LearnResultsController",a),a.$inject=["$scope","SessionService","LearnResult","PromptService","ToastService"]}(),function(){"use strict";function a(a,b,c,d){var e=b.project.get();a.chartModes={MULTIPLE_FINAL:0,MULTIPLE_COMPLETE:1},a.chartProperties=d.properties,a.results=[],a.selectedResults=[],a.selectedChartMode=null,a.selectedChartProperty=a.chartProperties.RESETS,a.fullWidth=!1,a.chartData={data:null,options:null},function(){c.Resource.getAllFinal(e.id).then(function(b){a.results=b})}(),a.selectChartProperty=function(b){a.selectedChartProperty=b,a.selectedChartMode===a.chartModes.MULTIPLE_FINAL?a.createChartFromFinalResults():a.selectedChartMode===a.chartModes.MULTIPLE_COMPLETE&&a.createChartFromCompleteResults()},a.createChartFromFinalResults=function(){var b;console.log(a.selectedResults),a.selectedResults.length>0&&(b=d.createDataFromMultipleFinalResults(a.selectedResults,a.selectedChartProperty),a.chartData={data:b.data,options:b.options},a.selectedChartMode=a.chartModes.MULTIPLE_FINAL)},a.createChartFromCompleteResults=function(){a.selectedResults.length>0},a.back=function(){a.selectedChartMode=null,a.chartData={data:null,options:null},a.fullWidth=!1}}angular.module("weblearner.controller").controller("LearnResultsStatisticsController",a),a.$inject=["$scope","SessionService","LearnResult","LearnerResultChartService"]}(),function(){"use strict";function a(a,b,c,d,e,f,g,h){var i=d.project.get();a.groups=[],a.allSymbols=[],a.learnConfiguration=new f,a.resetSymbol=null,function(){g.isActive().then(function(d){d.active?d.project==i.id?b.go("learn.start"):h.danger("There is already running a test from another project."):c.Resource.getAll(a.project.id,{embedSymbols:!0}).then(function(b){a.groups=b,a.allSymbols=_.flatten(_.pluck(a.groups,"symbols"))})})}(),a.setResetSymbol=function(b){a.resetSymbol=b},a.startLearning=function(){var c;return null===a.resetSymbol?void h.danger("You <strong>must</strong> selected a reset symbol in order to start learning"):(c=e.getSelected(a.allSymbols),void(c.length>0?(_.forEach(c,function(b){a.learnConfiguration.addSymbol(b)}),a.learnConfiguration.setResetSymbol(a.resetSymbol),g.start(a.project.id,a.learnConfiguration).then(function(){b.go("learn.start")})["catch"](function(a){h.danger("<p><strong>Start learning failed</strong></p>"+a.data.message)})):h.danger("You <strong>must</strong> at least select one symbol to start learning")))},a.updateLearnConfiguration=function(b){a.learnConfiguration=b},a.getAllSymbols=function(){return _.flatten(_.pluck(a.groups,"symbols"))}}angular.module("weblearner.controller").controller("LearnSetupController",a),a.$inject=["$scope","$state","SymbolGroup","SessionService","SelectionService","LearnConfiguration","LearnerService","ToastService"]}(),function(){function a(a,b,c,d,e,f){function g(){function c(b){e.Resource.getComplete(h.id,b.testNo).then(function(b){a.results=b})}a.active=!0,i=b(function(){d.isActive().then(function(e){e.active||(d.getStatus().then(c),b.cancel(i),a.active=!1)})},j)}var h=c.project.get(),i=null,j=1e4;a.results=[],a.active=!1,a.counterExample={input:"",output:""},function(){g(),a.$on("$destroy",function(){b.cancel(i)})}(),a.updateLearnConfiguration=function(b){a.test.configuration=b},a.resumeLearning=function(){var b=angular.copy(_.last(a.results).configuration);delete b.algorithm,delete b.symbols,delete b.resetSymbol,d.resume(h.id,_.last(a.results).testNo,b).then(g)},a.abort=function(){a.active&&(f.info("The learner will stop with the next hypothesis"),d.stop())},a.testCounterExample=function(){}}angular.module("weblearner.controller").controller("LearnStartController",a),a.$inject=["$scope","$interval","SessionService","LearnerService","LearnResult","ToastService"]}(),function(){"use strict";function a(a,b){a.project=b.project.get()}angular.module("weblearner.controller").controller("ProjectController",a),a.$inject=["$scope","SessionService"]}(),function(){"use strict";function a(a,b,c,d){a.project=new c,a.createProject=function(){c.Resource.create(a.project).then(function(a){d.success('Project "'+a.name+'" created'),b.go("home")})["catch"](function(a){d.danger("<p><strong>Creation of project failed</strong></p>"+a.data.message)})}}angular.module("weblearner.controller").controller("ProjectCreateController",a),a.$inject=["$scope","$state","Project","ToastService"]}(),function(){"use strict";function a(a,b,c,d,e,f,g){var h;a.project=d.project.get(),h=angular.copy(a.project),a.updateProject=function(){delete a.project.symbolAmount,c.Resource.update(a.project).then(function(b){SessionService.project.save(b),a.project=b,h=angular.copy(a.project)})},a.deleteProject=function(){function h(){e.confirm(i).then(function(){c.Resource["delete"](a.project).then(function(){f.success("Project <strong>"+a.project.name+"</strong> deleted"),d.project.remove(),b.go("home")})["catch"](function(a){f.danger("<p><strong>Deleting project failed</strong></p>"+a.data.message)})})}var i="Do you really want to delete this project with all its symbols and test results? This process can not be undone.";g.isActive().then(function(b){b.active!==!1||b.project!==a.project.id?h():f.info("Project could not be deleted because there is an active learning process")})},a.resetForm=function(){a.project=angular.copy(h)}}angular.module("weblearner.controller").controller("ProjectSettingsController",a),a.$inject=["$scope","$state","Project","SessionService","PromptService","ToastService","LearnerService"]}(),function(){"use strict";function a(a,b,c,d,e,f){function g(b){_.forEach(b.actions,function(a){a._id=_.uniqueId()}),a.symbol=b,a.symbolCopy=b.copy()}a.project=d.project.get(),a.symbol=null,a.symbolCopy=null,a.selectedActions=[],a.hasUnsavedChanges=!1,function(){c.Resource.get(a.project.id,b.symbolId).then(g)["catch"](function(){})}(),a.deleteSelectedActions=function(){a.selectedActions.length>0&&(_.forEach(a.selectedActions,a.deleteAction),f.success("Actions deleted")),a.hasUnsavedChanges=!0},a.deleteAction=function(b){_.remove(a.symbol.actions,{_id:b._id}),f.success("Action deleted"),a.hasUnsavedChanges=!0},a.addAction=function(b){console.log(b),b._id=_.uniqueId(),a.symbol.actions.push(b),f.success("Action created"),a.hasUnsavedChanges=!0},a.updateAction=function(b){var c=_.findIndex(a.symbol.actions,{_id:b._id});c>-1&&(a.symbol.actions[c]=b,f.success("Action updated")),a.hasUnsavedChanges=!0},a.saveChanges=function(){var b=a.symbol.copy();e.removeSelection(b.actions),_.forEach(b.actions,function(a){delete a._id}),c.Resource.update(a.project.id,b).then(function(b){g(b),f.success("Symbol <strong>"+b.name+"</strong> updated"),a.hasUnsavedChanges=!1})["catch"](function(a){f.danger("<p><strong>Error updating symbol</strong></p>"+a.data.message)})},a.revertChanges=function(){g(a.symbolCopy),f.info("Changes reverted to the last update"),a.hasUnsavedChanges=!1}}angular.module("weblearner.controller").controller("SymbolsActionsController",a),a.$inject=["$scope","$stateParams","Symbol","SessionService","SelectionService","ToastService"]}(),function(){"use strict";function a(a,b,c,d,e,f){function g(b){return e.find(a.groups,{id:b.group})}a.project=b.project.get(),a.groupsCollapsed=!1,a.selectedSymbols=[],a.groups=[],function(){d.Resource.getAll(a.project.id,{embedSymbols:!0}).then(function(b){a.groups=b})}(),a.getAllSymbols=function(){return e.flatten(e.pluck(a.groups,"symbols"))},a.addSymbol=function(a){g(a).symbols.push(a)},a.removeSymbols=function(a){var b;e.forEach(a,function(a){delete a._selected,b=g(a),e.remove(b.symbols,{id:a.id})})},a.updateSymbol=function(b){a.updateSymbols([b])},a.updateSymbols=function(a){var b,c;e.forEach(a,function(a){b=g(a),c=e.findIndex(b.symbols,{id:a.id}),c>-1&&(b.symbols[c].name=a.name,b.symbols[c].abbreviation=a.abbreviation,b.symbols[c].group=a.group)})},a.moveSymbolsToGroup=function(b,c){var c=e.find(a.groups,{id:c.id});e.forEach(b,function(b){var d=e.find(a.groups,{id:b.group}),f=e.findIndex(d.symbols,{id:b.id});d.symbols.splice(f,1),b.group=c.id,c.symbols.push(b)})},a.deleteSymbol=function(b){c.Resource["delete"](a.project.id,b).then(function(){f.success("Symbol <strong>"+b.name+"</strong> deleted"),a.removeSymbols([b])})["catch"](function(a){f.danger("<p><strong>Deleting symbol failed</strong></p>"+a.data.messageł)})},a.deleteSelectedSymbols=function(){c.Resource.deleteSome(a.project.id,a.selectedSymbols).then(function(){f.success("Symbols deleted"),a.removeSymbols(a.selectedSymbols)})["catch"](function(a){f.danger("<p><strong>Deleting symbols failed</strong></p>"+a.data.message)})},a.addGroup=function(b){a.groups.push(b)},a.updateGroup=function(b){e.find(a.groups,{id:b.id}).name=b.name},a.toggleCollapseAllGroups=function(){a.groupsCollapsed=!a.groupsCollapsed;for(var b=0;b<a.groups;b++)a.groups[b]._collapsed=a.groupsCollapsed}}angular.module("weblearner.controller").controller("SymbolsController",a),a.$inject=["$scope","SessionService","Symbol","SymbolGroup","_","ToastService"]}(),function(){"use strict";function a(a,b,c,d){var e=b.project.get();a.groups=[],a.allSymbols=[],c.Resource.getAll(e.id,{embedSymbols:!0}).then(function(b){a.groups=b,a.allSymbols=_.flatten(_.pluck(a.groups,"symbols"))}),a.getSelectedSymbols=function(){var b=angular.copy(d.getSelected(a.allSymbols));return d.removeSelection(b),_.forEach(b,function(a){delete a.id,delete a.revision,delete a.project,delete a.group,delete a.hidden}),b}}angular.module("weblearner.controller").controller("SymbolsExportController",a),a.$inject=["$scope","SessionService","SymbolGroup","SelectionService"]}(),function(){"use strict";function a(a,b,c,d,e){var f=d.project.get();a.revisions=[],a.latestRevision=null,function(){angular.isDefined(b.symbolId)&&c.Resource.getRevisions(f.id,b.symbolId).then(function(b){a.latestRevision=b[b.length-1],a.revisions=b})["catch"](function(){})}(),a.restoreRevision=function(b){var d=a.latestRevision.copy();d.name=b.name,d.abbreviation=b.abbreviation,d.actions=b.actions,c.Resource.update(f.id,d).then(function(c){e.success("Updated symbol to revision <strong>"+b.revision+"</strong>"),a.revisions.push(c),a.latestRevision=c})["catch"](function(a){e.danger("<p><strong>Update to revision failed</strong></p>"+a.data.message)})}}angular.module("weblearner.controller").controller("SymbolsHistoryController",a),a.$inject=["$scope","$stateParams","Symbol","SessionService","ToastService"]}(),function(){"use strict";function a(a,b,c,d,e){var f=b.project.get();a.symbols=[],a.fileLoaded=function(b){try{var c=angular.fromJson(b);a.$apply(function(){a.symbols=a.symbols.concat(c)})}catch(d){console.error(d)}},a.uploadSelectedSymbols=function(){var b=angular.copy(d.getSelected(a.symbols));b.length>0&&(d.removeSelection(b),c.Resource.createSome(f.id,b).then(function(b){e.forEach(b,function(b){e.remove(a.symbols,{name:b.name})})}))}}angular.module("weblearner.controller").controller("SymbolsImportController",a),a.$inject=["$scope","SessionService","Symbol","SelectionService","_"]}(),function(){"use strict";function a(a,b,c,d,e){var f=b.project.get();a.symbols=[],a.selectedSymbols=[],function(){c.Resource.getAll(f.id,{deleted:!0}).then(function(b){a.symbols=b})}(),a.recoverSymbol=function(b){c.Resource.recover(f.id,b).then(function(b){e.success("Symbol "+b.name+" recovered"),d.remove(a.symbols,{id:b.id})})["catch"](function(a){e.error("<p><strong>Error recovering symbol "+b.name+"!</strong></p>"+a.data.message)})},a.recoverSelectedSymbols=function(){a.selectedSymbols.length>0&&c.Resource.recoverSome(f.id,a.selectedSymbols).then(function(){e.success("Symbols recovered"),d.forEach(a.selectedSymbols,function(b){d.remove(a.symbols,{id:b.id})})})["catch"](function(a){e.error("<p><strong>Error recovering symbols!</strong></p>"+a.data.message)})}}angular.module("weblearner.controller").controller("SymbolsTrashController",a),a.$inject=["$scope","SessionService","Symbol","_","ToastService"]}(),function(){"use strict";function a(a,b){function c(c,d){function e(){var d=a.open({templateUrl:b.views.MODALS+"/action-create-modal.html",controller:"ActionCreateModalController"});d.result.then(function(a){c.onCreated()(a)})}d.on("click",e)}return{restrict:"A",scope:{onCreated:"&"},link:c}}angular.module("weblearner.directives").directive("actionCreateModalHandle",a),a.$inject=["$modal","paths"]}(),function(){"use strict";function a(a,b){function c(c,d){function e(){var d=a.open({templateUrl:b.views.MODALS+"/action-edit-modal.html",controller:"ActionEditModalController",resolve:{modalData:function(){return{action:c.action}}}});d.result.then(function(a){c.onUpdated()(a)})}d.on("click",e)}return{restrict:"A",scope:{action:"=",onUpdated:"&"},link:c}}angular.module("weblearner.directives").directive("actionEditModalHandle",a),a.$inject=["$modal","paths"]}(),function(){"use strict";function a(a,b,c,d,e){function f(f,g){function h(b){function c(b,f){return b.children||null!==f?void(0!==b.children.length&&(a.find(d,b.discriminator)||d.push(b.discriminator),null!==f&&e.push({from:f.discriminator,to:b.discriminator,label:b.edgeLabel}),a.forEach(b.children,function(a){a.data&&(d.push(a.data),e.push({from:b.discriminator,to:a.data,label:a.edgeLabel}))}),a.forEach(b.children,function(a){a.discriminator&&c(a,b)}))):void d.push(b.data)}var d=[],e=[];return c(b,null),{nodes:d,edges:e}}function i(b){var e=new d.Graph({directed:!0});return e.setGraph({}),a.forEach(b.nodes,function(a){e.setNode(a,{shape:"q"===a[0]?"rect":"circle",label:a,width:25,style:"fill: #fff; stroke: #000; stroke-width: 1",labelStyle:"font-size: 1.25em; font-weight: bold"})}),a.forEach(b.edges,function(a){e.setEdge(a.from,a.to,{lineInterpolate:"basis",style:"stroke: rgba(0, 0, 0, 0.3); stroke-width: 3; fill:none",label:a.label})}),c.dagre.layout(e,{}),e}function j(a){function d(){l.attr("transform","translate("+h.translate()+") scale("+h.scale()+")")}function f(){k.attr("width",m.clientWidth),k.attr("height",m.clientHeight)}(new c.render)(l,a);var g=(m.clientWidth-a.graph().width)/2;l.attr("transform","translate("+g+", 100)");var h=b.behavior.zoom().scaleExtent([.1,10]).translate([(m.clientWidth-a.graph().width)/2,100]).on("zoom",d);h(k),angular.element(e).on("resize",f),f(),window.setTimeout(function(){window.dispatchEvent(new Event("resize"))},100)}var k=b.select(g.find("svg")[0]),l=b.select(g.find("svg").find("g")[0]),m=g[0].parentNode;f.$watch("data",function(a){if(angular.isDefined(a)){var b=angular.fromJson(a),c=h(b),d=i(c);j(d)}})}return{scope:{data:"="},template:"<svg><g></g></svg>",link:f}}angular.module("weblearner.directives").directive("discriminationTree",a),a.$inject=["_","d3","dagreD3","graphlib","$window"]}(),function(){"use strict";function a(){function a(a,b,c){b.on("click",function(){var a=0;c.dispatchResize&&angular.isNumber(parseInt(c.dispatchResize))&&(a=parseInt(c.dispatchResize)),window.setTimeout(function(){window.dispatchEvent(new Event("resize"))},a)})}var b={restrict:"A",link:a};return b}angular.module("weblearner.directives").directive("dispatchResize",a)}(),function(){"use strict";function a(a){function b(b,c){function d(){angular.isDefined(b.data)&&a.prompt("Enter a name for the symbols file.",{regexp:/^[a-zA-Z0-9\.\-,_]+$/,errorMsg:'The name may not be empty and only consist of letters, numbers and the symbols ",._-".'}).then(e)}function e(a){var c,d="data:text/json;charset=utf-8,";if(angular.isDefined(b.data)){if(angular.isObject(b.data)||angular.isArray(b.data))d+=encodeURIComponent(angular.toJson(b.data));else{if(!angular.isFunction(b.data))return;d+=encodeURIComponent(angular.toJson(b.data()))}c=document.createElement("a"),c.style.display="none",c.setAttribute("href",d),c.setAttribute("target","_blank"),c.setAttribute("download",a+".json"),document.body.appendChild(c),c.click(),document.body.removeChild(c)}}c.on("click",d)}var c={restrict:"A",scope:{data:"="},link:b};return c}angular.module("weblearner.directives").directive("downloadAsJson",["PromptService",a])}(),function(){"use strict";function a(a,b){function c(c,d){function e(){var b="";angular.isDefined(c.results)&&(b=f(c.results),a.prompt("Enter a name for the csv file.",{regexp:/^[a-zA-Z0-9\.\-,_]+$/,errorMsg:'The name may not be empty and only consist of letters, numbers and the symbols ",._-".'}).then(function(a){g(b,a)}))}function f(a){var c="Project,Test No,Start Time,Step No,Algorithm,Eq Oracle,|Sigma|,#MQs,#EQs,#Symbol Calls,Duration (ms)\n";return b.forEach(a,function(a){c+=a.project+",",c+=a.testNo+",",c+='"'+a.statistics.startTime+'",',c+=a.stepNo+",",c+=a.configuration.algorithm+",",c+=a.configuration.eqOracle.type+",",c+=a.configuration.symbols.length+",",c+=a.statistics.mqsUsed+",",c+=a.statistics.eqsUsed+",",c+=a.statistics.symbolsUsed+",",c+=a.statistics.duration+"\n"}),c}function g(a,b){var c=document.createElement("a");c.style.display="none",c.setAttribute("href","data:text/csv;charset=utf-8,"+encodeURIComponent(a)),c.setAttribute("target","_blank"),c.setAttribute("download",b+".csv"),document.body.appendChild(c),c.click(),document.body.removeChild(c)}d.on("click",e)}var d={restrict:"A",scope:{results:"="},link:c};return d}angular.module("weblearner.directives").directive("downloadLearnerResultsAsCsv",a),a.$inject=["PromptService","_"]}(),function(){function a(a){function b(b,c,d){function e(){var b=null;angular.isDefined(d.downloadSvg)&&(b=f(d.downloadSvg),null!==b&&a.prompt("Enter a name for the svg file.",{regexp:/^[a-zA-Z0-9\.\-,_]+$/,errorMsg:'The name may not be empty and only consist of letters, numbers and the symbols ",._-".'}).then(function(a){g(b,a)}))}function f(a){var b=document.querySelector(a);return null!==b&&("svg"!==b.nodeName.toLowerCase()&&(b=b.querySelector("svg")),null!==b)?b:null}function g(a,b){a.setAttribute("version","1.1"),a.setAttribute("xmlns","http://www.w3.org/2000/svg");var c=(new XMLSerializer).serializeToString(a),d=window.btoa(c),e=document.createElement("a");e.style.display="none",e.setAttribute("href","data:image/svg+xml;base64,\n"+d),e.setAttribute("target","_blank"),e.setAttribute("download",b+".svg"),document.body.appendChild(e),e.click(),document.body.removeChild(e)}c.on("click",e)}var c={restrict:"A",link:b};return c}angular.module("weblearner.directives").directive("downloadSvg",a),a.$inject=["PromptService"]}(),function(){"use strict";function a(){function a(){}return{link:a}}angular.module("weblearner.directives").directive("downloadTableAsCsv",a)}(),function(){"use strict";function a(){function a(a,b,c,d){b.on("mouseenter",function(){a.$apply(function(){d.toggle(!0)})})}var b={restrict:"A",require:"dropdown",link:a};return b}angular.module("weblearner.directives").directive("dropdownHover",a)}(),function(){"use strict";function a(){function a(a,b){function c(a){for(var b=0;b<a.length;b++)d.readAsText(a[b])}var d=new FileReader;d.onload=function(b){a.onLoaded()(b.target.result)},b.on("dragover",function(a){a.preventDefault(),a.stopPropagation(),a.dataTransfer.dropEffect="copy"}),b.on("dragenter",function(){b[0].style.outline="2px solid rgba(0,0,0,0.2)"}).on("dragleave",function(){b[0].style.outline="0"
    ...
    function a(a) {
        ...
        var c = {restrict: "A", scope: {bindResize: "=", asStyle: "="}, link: b};
        return c
    }
    ...
    function a(a, b, c) {
        return {
            restrict: "A", scope: {selectorModel: "=model"}, link: function (d, e) {
                var f;
                e.on("click", function () {
    ...
    function b(a) {
        ...
        return {
            close: function (a) {
                angular.isDefined(a) ? b.resolve(a) : b.reject()
            }, open: function () {
                return b = a.defer(), b.promise
            }, setUrl: function (a) {
                c = a
            }, getUrl: function () {
                return c
    ...
    function d(a, c) {
        function d(c, d) {
            ...
            function f() {
                d.find("svg")[0].innerHTML = ""
            }

            function g() {
                m = d3.select(d.find("svg")[0]), n = m.append("g"), o = m.node().parentNode, p = new graphlib.Graph({
                    directed: !0,
                    multigraph: !0
                }), p.setGraph(angular.isDefined(c.layoutSettings) ? {
            ...
            function h() {
                angular.isDefined(c.layoutSettings) && c.layoutSettings.multigraph ? i() : j()
            }
            ...
            function k() {
                (q = new dagreD3.render)(n, p);
                var a = (o.clientWidth - p.graph().width) / 2;
                n.attr("transform", "translate(" + a + ", 100)")
            }

            function l() {
                function d() {
                    n.attr("transform", "translate(" + h.translate() + ") scale(" + h.scale() + ")")
                }
                ...
                function g() {
                    m.attr("width", o.clientWidth), m.attr("height", o.clientHeight)
                }

                var h, f;
                angular.isDefined(c.counterExample) && m.selectAll(".edgeLabel tspan").on("click", function () {
                    var a = this.innerHTML.split("/");
                    c.$apply(function () {
                        c.counterExample.input += a[0] + ",", c.counterExample.output += a[1] + ","
                    })
                }), h = d3.behavior.zoom().scaleExtent([.1, 10]).translate([(o.clientWidth - p.graph().width) / 2, 100]).on("zoom", d), h(m), f = d3.behavior.drag().origin(function (a) {
                    return a
                }).on("dragstart", e).on("drag", f), m.selectAll(".node").attr("cx", function (a) {
                    return a.x
                }).attr("cy", function (a) {
                    return a.y
                }).call(f), angular.element(a).on("resize", g), window.setTimeout(function () {
            ...
            c.$watch("test", function (a) {
                angular.isDefined(a) && null != a && e()
            }), c.$watch("layoutSettings", function (a) {
                angular.isDefined(a) && e()
            })
        }

        var e = {
            scope: {test: "=", counterExample: "=", layoutSettings: "="},
    ...
    angular.module("weblearner.directives").directive("hypothesis", d), d.$inject = ["$window", "paths"]
}(), function () {
    "use strict";
    function a() {
        function a(a) {
    ...
    function a(a, b) {
        ...
        var d = {templateUrl: b.views.DIRECTIVES + "/load-screen.html", link: c};
        return d
    }
    ...
    function a(a, b) {
        ...
        var d = {scope: {layoutSettings: "="}, link: c};
        return d
    }

    angular.module("weblearner.directives").directive("openHypothesisLayoutSettingsModal", a), a.$inject = ["$modal", "paths"]
}(), function () {
    "use strict";
    function a(a, b) {
        function c(c, d) {
            function e() {
                var d = a.open({
                    ...
                    resolve: {
                        modalData: function () {
                            return {learnConfiguration: c.learnConfiguration.copy()}
                        }
                    }
                });
                d.result.then(function (a) {
        ...
        var d = {restrict: "EA", scope: {learnConfiguration: "=", onOk: "&"}, link: c};
        return d
    }

    angular.module("weblearner.directives").directive("openLearnSetupSettingsModal", a), a.$inject = ["$modal", "paths"]
}(), function () {
    "use strict";
    function a() {
        function a(a, b) {
    ...
    function a() {
        function a(a, b, c) {
            a.title = c.widgetTitle || "Untitled", a.collapsed = a.collapsed || !1, a.toggleCollapse = function () {
                a.collapsed = !a.collapsed
            }
        }

        var b = '<div class="panel panel-default">   <div class="panel-heading">       <div class="pull-right">           <span class="panel-collapse-handle" ng-click="toggleCollapse()">               <i class="fa" ng-class="collapsed? \'fa-plus-square\' : \'fa-minus-square\'"></i>           </span>       </div>       <strong class="text-muted" ng-bind="title"></strong>   </div>   <div class="panel-body" ng-show="!collapsed" ng-transclude></div></div>', c = {
            scope: {collapsed: "="},
            template: b,
            transclude: !0,
            link: a
    ...
    function b(a) {
        function b(a) {
            a.addCounterExample = function () {
                var b = {input: [], output: []};
                _.forEach(a.newCounterExample.input.split(","), function (a) {
                    "" != a.trim() && b.input.push(a.trim())
                }), _.forEach(a.newCounterExample.output.split(","), function (a) {
                    "" != a.trim() && b.output.push(a.trim())
                }), a.counterExamples.push(b), a.newCounterExample.input = "", a.newCounterExample.output = ""
            }, a.removeCounterExample = function (b, c) {
                a.counterExamples.splice(c, 1)
            }
        }

        return {
            templateUrl: a.views.DIRECTIVES + "/widget-counter-examples.html",
            scope: {counterExamples: "=", newCounterExample: "=counterExample"},
            controller: ["$scope", b]
        }
    }
    ...
    function c(a) {
        function b(a, b, c) {
            a.eqOracles = b, a.$watch("configuration.eqOracle.type", function (b) {
                a.configuration.eqOracle = c.createFromType(b)
            })
        }

        return {
            templateUrl: a.views.DIRECTIVES + "/widget-test-resume-settings.html",
            scope: {configuration: "="},
            controller: ["$scope", "eqOracles", "EqOracle", b]
        }
    }

    angular.module("weblearner.directives").directive("widget", a), angular.module("weblearner.directives").directive("widgetCounterExamples", b), b.$inject = ["paths"], angular.module("weblearner.directives").directive("widgetTestResumeSettings", c), c.$inject = ["paths"]
}(), function () {
    "use strict";
    function a(a, b) {
        function c(c, d) {
        ...
        function c(c, d) {
            function e() {
                ...
                var e = a.open({
                    ...
                    resolve: {
                        modalData: function () {
                            return {symbols: d, groups: c.groups}
                        }
                    }
                });
    ...
    function a(a) {
        function b() {
            this.negated = !1, this.ignoreFailure = !1
        }

        return b.Web = function () {
        }, b.Web.SearchForText = function (c, d) {
            b.call(this), this.type = a.web.SEARCH_FOR_TEXT, this.value = c || null, this.regexp = d || !1
            ...
            b.call(this), this.type = a.web.SEARCH_FOR_NODE, this.value = c || null, this.regexp = d || !1
            ...
            b.call(this), this.type = a.rest.CHECK_HEADER_FIELD, this.key = c || null, this.value = d || null, this.regexp = e || !1
            ...
            b.call(this), this.type = a.rest.CHECK_HTTP_BODY_TEXT, this.value = c || null, this.regexp = d || !1
            ...
            b.call(this), this.type = a.rest.CHECK_ATTRIBUTE_EXISTS, this.attribute = this.attribute = c || null
            ...
            b.call(this), this.type = a.rest.CHECK_ATTRIBUTE_VALUE, this.attribute = c || null, this.value = d || null, this.regexp = e || !1
            ...
            b.call(this), this.type = a.rest.CHECK_ATTRIBUTE_TYPE, this.attribute = c || null, this.jsonType = d || null
            ...
            this.type = a.other.EXECUTE_SYMBOL, this.symbolToExecute = d || {
                id: null,
                revision: null
            ...
            b.call(this), this.type = a.other.SET_VARIABLE_BY_JSON_ATTRIBUTE, this.name = c || null, this.value = d || null
            ...
            b.call(this), this.type = a.other.SET_VARIABLE_BY_NODE, this.name = c || null, this.value = d || null
    ...
    function a(a) {
        ...
        function e(e) {
            ...
            switch (e.type) {
                case a.RANDOM:
                    f = new b(e.minLength, e.maxLength);
                    break;
                case a.COMPLETE:
    ...
    function a(a, b) {
        function c() {
            this.symbols = [], this.maxAmountOfStepsToLearn = 0, this.eqOracle = new b.Complete, this.algorithm = a.EXTENSIBLE_LSTAR, this.resetSymbol
        }

        return c.prototype.setResetSymbol = function (a) {
