...
public class LearnerResultResource {
    ...
    /** The {@link de.learnlib.weblearner.core.dao.LearnerResultDAO} to use. */
    @Inject
     ...
     * @responseType    java.util.List<de.learnlib.weblearner.core.entities.LearnerResult>
     ...
     * @successResponse 200 OK
     * @responseType de.learnlib.weblearner.core.entities.LearnerResult
     * @errorResponse   404 not found `de.learnlib.weblearner.utils.ResourceErrorHandler.RESTError
     */
    @GET
    @Path("{test_no}")
