...
import de.learnlib.weblearner.core.entities.SymbolVisibilityLevel;
...
public class SymbolResource {
     ...
     * @responseType de.learnlib.weblearner.core.entities.Symbol
     ...
     * @responseType java.util.List<de.learnlib.weblearner.core.entities.Symbol>
     * @successResponse 201 created
     * @errorResponse   400 bad request `de.learnlib.weblearner.utils.ResourceErrorHandler.RESTError
     */
    @POST
