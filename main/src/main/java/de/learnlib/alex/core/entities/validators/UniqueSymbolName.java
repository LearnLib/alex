...
/**
 * Annotation for the the Symbol class that checks, that every Symbol name is unique per User and Project.
 * See http://docs.jboss.org/hibernate/validator/5.2/reference/en-US/html/ch06.html for more details.
 */
@Target({ TYPE, ANNOTATION_TYPE })
@Retention(RUNTIME)
@Constraint(validatedBy = { UniqueSymbolNameValidator.class })
@Documented
public @interface UniqueSymbolName {
     ...
     */
    String message() default "{de.learnlib.alex.core.entities.validators.UniqueSymbolName.message}";
