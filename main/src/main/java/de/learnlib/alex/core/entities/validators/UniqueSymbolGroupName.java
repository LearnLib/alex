...
/**
 * Annotation for the the SymbolGroup class that checks, that every SymbolGroup name is unique per User and Project.
 * See http://docs.jboss.org/hibernate/validator/5.2/reference/en-US/html/ch06.html for more details.
 */
@Target({ TYPE, ANNOTATION_TYPE })
@Retention(RUNTIME)
@Constraint(validatedBy = { UniqueSymbolGroupNameValidator.class })
@Documented
public @interface UniqueSymbolGroupName {
     ...
     */
    String message() default "{de.learnlib.alex.core.entities.validators.UniqueSymbolGroupName.message}";
