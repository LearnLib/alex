describe('HomeController', function(){
    var $scope, paths, Session, $state, $httpBackend, Project, $rootScope;
    var getAllProjectsRequestHandler;
    var projects;

    beforeEach(angular.mock.module('ALEX'));
    beforeEach(angular.mock.module('ALEX.core'));
    beforeEach(angular.mock.inject(function(_$rootScope_, _$controller_, _SessionService_, _Project_,
                                            _ProjectResource_, _$state_, _$httpBackend_, _paths_) {
