(function () {
    ...
    CheckHTTPBodyTextRestActionFactory.$inject = ['ActionService', 'AbstractAction', 'actionGroupTypes', 'actionTypes'];
     ...
     * @constructor
     */
    function CheckHTTPBodyTextRestActionFactory(ActionService, AbstractAction, actionGroupTypes, actionTypes) {
