(function () {
    ...
    CheckForTextWebActionFactory.$inject = ['ActionService', 'AbstractAction', 'actionGroupTypes', 'actionTypes'];
     ...
     * @constructor
     */
    function CheckForTextWebActionFactory(ActionService, AbstractAction, actionGroupTypes, actionTypes) {
