(function () {
    ...
    CheckPageTitleActionFactory.$inject = ['ActionService', 'AbstractAction', 'actionGroupTypes', 'actionTypes'];
     ...
     * @constructor
     */
    function CheckPageTitleActionFactory(ActionService, AbstractAction, actionGroupTypes, actionTypes) {
        ...
        ActionService.register(actionGroupTypes.WEB, actionTypes[actionGroupTypes.WEB].CHECK_PAGE_TITLE, CheckPageTitleAction);
