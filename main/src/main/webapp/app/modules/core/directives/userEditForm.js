(function () {
     ...
     */
    function userEditForm(paths, $state, SessionService, ToastService, UserResource, PromptService) {
        return {
            scope: {
                user: '='
            },
            templateUrl: paths.COMPONENTS + '/core/views/directives/user-edit-form.html',
            link: link
        };
    ...
    userEditForm.$inject = ['paths', '$state', 'SessionService', 'ToastService', 'UserResource', 'PromptService'];
}());