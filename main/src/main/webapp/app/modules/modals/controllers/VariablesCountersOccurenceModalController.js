(function () {
    ...
    VariablesCountersOccurrenceModalController.$inject = [
        '$scope', '$modalInstance', 'SessionService', 'SymbolGroupResource', '_'
    ];
     ...
     * @constructor
     */
    function VariablesCountersOccurrenceModalController($scope, $modalInstance, Session, SymbolGroupResource, _) {
