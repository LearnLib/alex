(function () {
    ...
    SymbolEditModalController.$inject = [
        '$scope', '$modalInstance', 'modalData', 'Symbol', 'SymbolResource', 'ToastService'
    ];
     ...
     * @constructor
     */
    function SymbolEditModalController($scope, $modalInstance, modalData, Symbol, SymbolResource, Toast) {
