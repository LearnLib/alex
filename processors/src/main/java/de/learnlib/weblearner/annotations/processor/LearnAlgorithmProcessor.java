...
@SupportedAnnotationTypes("de.learnlib.weblearner.annotations.LearnAlgorithm")
...
public class LearnAlgorithmProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> set, RoundEnvironment roundEnvironment) {
        ...
        try {
            ...
            JavaFileObject jfo = processingEnv.getFiler().createSourceFile("de.learnlib.weblearner.core.entities.LearnAlgorithms");
